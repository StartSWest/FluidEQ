...
The FluidEQ name, visual identity, automatic device-profile implementation, and
subsequent modifications distinguish this derivative project from upstream.
