...
const eq: Partial<Dictionary> = {
  ...
  'graph.scene.resetView': 'Ansicht zurücksetzen',
  ...
  'graph.sceneTint.label': 'Fensterfarben',
  'graph.sceneTint.about.off': 'Das Fenster in Ihrem Design.',
  'graph.sceneTint.about.tint': 'Das Fenster in den Farben des Visualizers.',
  ...
  'graph.legend.peak': 'Spitze',
  'graph.legend.average': 'Mittel',
  'graph.legend.max': 'Max',
  'graph.legend.before': 'Vorher',
  'graph.legend.after': 'Nachher',
  'graph.legend.phase': 'Phase',
  'graph.legend.width': 'Breite',
  ...
  'graph.styleName.compare': 'Vorher & nachher',
  'graph.styleName.spectrogram': 'Spektrogramm',
  'graph.styleName.rta': 'Terzoktav-RTA',
  'graph.styleName.average': 'Spitze & Mittelwert',
  'graph.styleName.waterfall': 'Wasserfall',
  'graph.styleName.loudness': 'Stereo & Pegel',
  'graph.styleName.scope': 'Oszilloskop',
  'graph.styleName.midside': 'Mitte & Seite',
  'graph.styleName.notes': 'Notenspektrum',
  'graph.styleName.energy': 'Energiebänder',
  'graph.styleName.phase': 'Phasenverlauf',
  'graph.styleName.ledwall': 'LED-Wand',
  'graph.styleName.towers': 'Glastürme',
  'graph.styleName.tide': 'Gezeiten',
  'graph.styleName.halo': 'Halo',
  'graph.styleName.synthwave': 'Synthwave',
  'graph.styleName.ledbars': 'LED-Balken',
  'graph.styleName.neonbars': 'Neonbalken',
  'graph.styleName.bars3d': '3D-Balken',
  'graph.styleName.spectrumwave': 'Spektrumwelle',
  'graph.styleName.silkwaves': 'Seidenwellen',
  'graph.styleName.mirrorbars': 'Spiegelbalken',
  'graph.styleName.pixelbars': 'Pixelbalken',
  'graph.styleName.sparkbars': 'Funkenbalken',
  'graph.styleName.glitchbars': 'Glitch-Balken',
  'graph.styleName.halftone': 'Rasterpunkte',
  'graph.styleName.bouncedots': 'Hüpfende Punkte',
  ...
  'output.hint':
    'Änderungen werden im aktiven Profil gespeichert und folgen dieser Ausgabe, wann immer Windows sie auswählt.',
  ...
  'eq.smart.status.failed': 'Die Quelle konnte nicht gemessen werden.',
  ...
  'eq.smart.error.noSource':
    'Der Ton vor der Verarbeitung durch FluidEQ ist nicht erreichbar.',
  ...
  'convolution.intro':
    'Laden Sie eine geprüfte Minimalphasen-Impulsantwort für Ihren Hörer und wenden Sie sie vor dem parametrischen EQ an. Der Frequenzgang zeigt beide Kurven.',
