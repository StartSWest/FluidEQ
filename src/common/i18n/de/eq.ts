...
const eq: Partial<Dictionary> = {
  ...
  'graph.styleName.beams': 'Lichtstrahlen',
  'graph.styleName.sparkbars': 'Funkenbalken',
  'graph.styleName.glitchbars': 'Glitch-Balken',
  'graph.styleName.orb': 'Kugel',
  'graph.styleName.kaleido': 'Kaleidoskop',
  'graph.styleName.helix': 'Helix',
  'graph.styleName.mesh': 'Gitternetz',
