const terms = {
  ...
  'terms.membership.p1':
    'Plus erweitert FluidEQ um Premium-Visualisierungen, das Studio zum Erstellen eigener Szenen und zum Teilen mit anderen Mitgliedern, das Schreiben in der Community und die Rangliste. Es kostet {price} und verlängert sich am Ende jedes bezahlten Zeitraums, bis Sie kündigen.',
  'terms.membership.p2':
  ...
  'terms.sent.intro':
    'Nur für die Funktionen, die Sie nutzen, und immer über eine verschlüsselte Verbindung. Ohne Konto ist die einzige Anfrage die nach der öffentlichen Liste der Plus-Looks, und sie enthält nichts über Sie.',
  ...
  'terms.sent.community.what':
    'Ihr Handle und Anzeigename, Ihre Nachrichten und deren @Erwähnungen, Ihre Meldungen und die Personen, die Sie blockieren',
  'terms.sent.community.when':
    'Wenn Sie Ihr Profil anlegen, schreiben, melden oder blockieren',
  ...
  'terms.protect.p3':
    'Rangliste und Chat zeigen Handles, niemals E-Mail-Adressen oder Konto-IDs.',
  'terms.protect.p4':
    'Der Macher betreibt den Server und kann sehen, was er speichert, um ihn am Laufen zu halten und die Community zu moderieren. Nichts wird verkauft, weitergegeben oder für Werbung genutzt, und es gibt kein Tracking und keine Analysen.',
  'terms.protect.p5':
  ...
  'terms.community.p1':
    'Seien Sie freundlich. Keine Belästigung, kein Hass, keine Drohungen, kein Spam, keine illegalen Inhalte und keine persönlichen Daten anderer. Alle Mitglieder können lesen, was Sie posten, also teilen Sie nur, was gelesen werden darf.',
  'terms.community.p2':
    'Ihre eigenen Nachrichten können Sie jederzeit löschen. Der Macher kann Nachrichten entfernen und Konten sperren, die gegen diese Regeln verstoßen. Melden Sie eine Nachricht, um sie zu markieren; Meldungen sieht nur der Macher.',
  ...
  'terms.keep.p2':
    'Nachrichten: Sie bleiben, bis Sie oder der Macher sie löschen.',
  'terms.keep.p3':
