...
const app: Partial<Dictionary> = {
  ...
  'app.status.checking': 'Audio-Engine wird geprüft…',
  'app.status.error': 'Die Audio-Engine antwortet nicht',
  ...
  'engine.apo.reconfigure': 'Equalizer APO neu einrichten',
  'engine.apo.settings': 'Equalizer-APO-Einstellungen',
  ...
  'app.processes.name.meter': 'Prozessmesser',
  'app.processes.what.meter':
    'Misst die Werte in dieser Liste so wie der Task-Manager, damit sie sich addieren lassen. Läuft nur, solange diese Liste geöffnet ist.',
  'app.processes.name.lighting': 'Dynamische Beleuchtung',
  'app.processes.what.lighting':
    'Gibt die Farben der Szene an Geräte weiter, die mit Windows Dynamic Lighting funktionieren. Läuft nur, solange die Beleuchtung an oder ihre Seite geöffnet ist.',
  ...
  'prereq.install.apo': 'APO installieren',
  'prereq.install.fluid': 'FluidEQ-Engine installieren',
  'prereq.retry': 'Erneut versuchen',
  'prereq.dismiss': 'Ausblenden',
  'prereq.credit.apo':
    'Equalizer APO ist in {product} enthalten — es wird nichts heruntergeladen. Seine Einrichtung fragt, welche Audiogeräte entzerrt werden sollen, und danach nach einem Neustart. Eigenständiges GPLv2-Projekt von {author}, unverändert beigelegt.',
  'prereq.starting': 'Wird gestartet…',
  ...
  'app.tray.recoverWindow': 'Fenster wiederherstellen',
  'app.tray.quit': '{product} beenden',
  'app.tray.tooltip': '{product} — läuft weiterhin',
  'app.tray.installUpdate': 'Update installieren und neu starten',
  'app.tray.checkForUpdates': 'Nach Updates suchen',
  'app.tray.tooltip.updateReady': '{product} — Update bereit zur Installation',
  'app.notification.updateReady.title': 'FluidEQ-Update bereit',
  'app.notification.updateReady.body':
    'Version {version} ist bereit. Klicken Sie, um FluidEQ neu zu starten.',
  'app.notification.updateReady.bodyNoVersion':
    'Ein Update ist bereit. Klicken Sie, um FluidEQ neu zu starten.',
  'app.notification.upToDate.title': 'FluidEQ ist aktuell',
  'app.notification.upToDate.body': 'Sie haben bereits die neueste Version.',
  'app.notification.updateFound.title': 'FluidEQ-Update gefunden',
  'app.notification.updateFound.body':
    'Version {version} wird heruntergeladen. Sie werden benachrichtigt, sobald sie installiert werden kann.',
  'app.notification.checkFailed.title': 'Suche nach Updates nicht möglich',
  'app.notification.checkFailed.body':
    'Der Updateserver war nicht erreichbar. FluidEQ versucht es später erneut.',
  'app.notification.installFailed.title':
    'Update konnte nicht installiert werden',
  'app.notification.installFailed.body':
    'FluidEQ konnte das Installationsprogramm nicht starten. Klicken Sie, um FluidEQ zu öffnen und es erneut zu versuchen.',
  ...
  'restart.declined':
    'Die Windows-Berechtigung wurde verweigert, daher wurde der Ton nicht neu gestartet.',
  ...
  'sidebar.state.on': '{engine} · an',
  'sidebar.state.off': 'Aus',
  'sidebar.state.notOnOutput': 'Nicht auf dieser Ausgabe',
  ...
  'settings.group.visualizer': 'Der Visualizer',
