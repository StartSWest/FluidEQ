...
const look: Partial<Dictionary> = {
  ...
  'look.peakStyle': 'Markierung',
  'look.peak.fall': 'Abfall',
  'look.peak.ghost': 'Geist',
  'look.peak.ripple': 'Welle',
  'look.peak.sparks': 'Funken',
  'look.peak.beam': 'Strahl',
  'look.peak.ceiling': 'Decke',
  'look.peak.comet': 'Komet',
  'look.peak.drip': 'Tropfen',
  'look.peak.bead': 'Kasten',
  'look.peak.cap': 'Kappe',
  'look.peak.ring': 'Ring',
  'look.peak.spark': 'Funke',
  'look.peak.chevron': 'Winkel',
  'look.peak.halo': 'Halo',
  'look.peak.pin': 'Nadel',
  'look.peak.crown': 'Krone',
  'look.peak.cross': 'Kreuz',
  'look.peak.wave': 'Welle',
