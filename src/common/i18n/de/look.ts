...
const look: Partial<Dictionary> = {
  'look.textureStyle': 'Textur',
  'look.texture.none': 'Schlicht',
  'look.texture.hatch': 'Schraffur',
  'look.texture.crosshatch': 'Kreuzschraffur',
  'look.texture.rules': 'Linien',
  'look.texture.pinstripe': 'Nadelstreifen',
  'look.texture.dots': 'Punkte',
  'look.texture.grid': 'Raster',
  'look.texture.weave': 'Geflecht',
  'look.texture.scales': 'Schuppen',
  'look.texture.chevron': 'Chevron',
  'look.texture.static': 'Korn',
  'look.texture.image': 'Bild',
  'look.texture.replace': 'Bild ändern',
  'look.texture.tooBig':
    'Dieses Bild ist zu groß zum Speichern. Wählen Sie ein kleineres.',
  'look.texture.unreadable':
    'Diese Datei konnte nicht als Bild gelesen werden.',
  'look.tilt': 'Neigung',
  'look.tiltHint':
    'Dezibel pro Oktave. Kippt die Anzeige zu den Höhen, damit eine ausgewogene Mischung gerade erscheint.',
  'look.tiltValue': '{value} dB/Okt',
  'look.channels': 'Kanäle',
  'look.channels.joined': 'Zusammen',
  'look.channels.split': 'Links & rechts',
