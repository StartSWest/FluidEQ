...
const app: Partial<Dictionary> = {
  ...
  'app.processes.name.desktop': 'Visualizzatore del desktop',
  'app.processes.what.desktop':
    'Un visualizzatore Plus disegnato come sfondo del desktop di un monitor, separato da questa finestra: uno per ogni monitor che ne mostra uno. Va in pausa mentre le finestre coprono quel monitor o il PC è bloccato.',
  ...
  'app.processes.name.meter': 'Misuratore dei processi',
  'app.processes.what.meter':
    'Misura i valori di questo elenco come Gestione attività, così la somma torna. È attivo solo mentre questo elenco è aperto.',
  'app.processes.name.lighting': 'Illuminazione dinamica',
  'app.processes.what.lighting':
    'Passa i colori della scena ai dispositivi compatibili con Windows Dynamic Lighting. È attivo solo mentre l’illuminazione è accesa o la sua pagina è aperta.',
  ...
  'engine.fluid.l4':
    'Equalizer APO viene disattivato mentre questo motore è in uso e rimesso com’era se ci torni',
  ...
  'restart.declined':
    'Il permesso di Windows è stato negato, quindi l’audio non è stato riavviato.',
  ...
  'sidebar.headroom.fluid': 'MARGINE',
  ...
  'config.title.fluid': 'Configurazione del motore FluidEQ',
  'config.lede':
  ...
  'config.absent.fluid':
    'FluidEQ non ha ancora scritto la configurazione del motore FluidEQ.',
  ...
  'config.status.notIncluded.fluid':
    'Il motore FluidEQ non sta leggendo questa configurazione. Nulla di quanto segue viene applicato.',
  'config.status.engineOff':
    'L’EQ di sistema è spento: questa configurazione non nomina alcuna uscita, quindi Equalizer APO non ne applica nulla.',
  'config.status.engineOff.fluid':
    'L’EQ di sistema è spento: questa configurazione non nomina alcuna uscita, quindi il motore FluidEQ non ne applica nulla.',
  'config.status.active':
    'Attiva — Equalizer APO sta applicando questa configurazione.',
  'config.status.active.fluid':
    'Attiva — il motore FluidEQ sta applicando questa configurazione.',
  'config.outputsAria': 'Uscite nella configurazione di Equalizer APO',
  'config.outputsAria.fluid': 'Uscite nella configurazione del motore FluidEQ',
  ...
  'config.hint.saving.fluid':
    'Salvando si scrive il file; il motore FluidEQ lo recepisce.',
  ...
  'settings.group.visualizer': 'Il visualizzatore',
  'settings.group.drawing': 'Come viene disegnato',
  'settings.group.thisView': 'Questa vista',
  'settings.group.studioOnly': 'Solo qui nello Studio',

  // Game profiles: the page, its list and what it says.
  'games.add': 'Aggiungi un gioco',
  'games.addHint':
    'Scegli un gioco dai tuoi launcher, o un programma aperto adesso.',
  'games.choose': 'Scegli un programma…',
  'games.group.installed': 'Installati',
  'games.group.running': 'Aperti ora',
  ...
  'games.source.running': 'Aperto ora',
  ...
  'games.empty.more':
    'Aggiungi un gioco, dagli un suono, e FluidEQ passa a quello appena il gioco è in primo piano — e torna indietro quando lo lasci.',
  'games.hint':
    'Il suono cambia quando il gioco passa in primo piano e torna indietro quando lo lasci. Se ne scegli un altro mentre giochi, resta: FluidEQ rimette solo ciò che ha messo.',
  'games.preset.none': 'Lascia com’è',
  'games.preset.noneHint':
    'Non cambia nulla quando questo gioco è in primo piano.',
  'games.row.inFront': 'in primo piano',
