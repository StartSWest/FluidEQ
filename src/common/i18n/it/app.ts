...
const app: Partial<Dictionary> = {
  ...
  'app.tray.recoverWindow': 'Ripristina la finestra',
  ...
  'sidebar.state.on': '{engine} · attivo',
  'sidebar.state.off': 'Spento',
  'sidebar.state.notOnOutput': 'Non su questa uscita',
  ...
  'games.toast.restoredNone': 'Effetti di nuovo spenti',
  'games.toast.afterGame': 'dopo {game}',
