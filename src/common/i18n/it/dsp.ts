...
const dsp = {
  ...
  'dsp.eqPreset.tapeRestore': 'Ripara nastro',
  'dsp.eqPreset.vinylRestore': 'Ripara vinile',
  ...
  'dsp.eqTreble.preciseHint':
    'Preciso: ogni banda di questo EQ suona esattamente come è disegnata, fino a 20\u00a0kHz.',
