...
const look: Partial<Dictionary> = {
  'look.textureStyle': 'Trama',
  'look.texture.none': 'Liscio',
  'look.texture.hatch': 'Tratteggio',
  'look.texture.crosshatch': 'Tratteggio incrociato',
  'look.texture.rules': 'Righe',
  'look.texture.pinstripe': 'Gessato',
  'look.texture.dots': 'Punti',
  'look.texture.grid': 'Griglia',
  'look.texture.weave': 'Intreccio',
  'look.texture.scales': 'Squame',
  'look.texture.chevron': 'Chevron',
  'look.texture.static': 'Grana',
  'look.texture.image': 'Immagine',
  'look.texture.replace': 'Cambia immagine',
  'look.texture.tooBig':
    'Questa immagine è troppo grande da conservare. Provane una più piccola.',
  'look.texture.unreadable':
    'Non è stato possibile leggere questo file come immagine.',
  'look.tilt': 'Pendenza',
  'look.tiltHint':
    'Decibel per ottava. Inclina la visualizzazione verso gli acuti, così un mix equilibrato appare piatto.',
  'look.tiltValue': '{value} dB/ott',
  'look.channels': 'Canali',
  'look.channels.joined': 'Uniti',
  'look.channels.split': 'Sinistro e destro',
