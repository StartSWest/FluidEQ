...
const look: Partial<Dictionary> = {
  'look.connectingLine': 'Linea di collegamento',
  'look.peak.blink': 'Lampeggio a ritmo',
  'look.peakFill': 'Riempi i picchi',
  'look.peak.live': 'Picchi dal vivo',
  'look.peakLayer': 'Posizione dei picchi',
  'look.peakFront': 'Davanti all’onda',
  'look.peakBehind': 'Dietro l’onda',
  ...
  'look.peak.fall': 'Caduta',
  'look.peak.ghost': 'Fantasma',
  'look.peak.ripple': 'Increspatura',
  'look.peak.sparks': 'Scintille',
  'look.peak.beam': 'Fascio',
  'look.peak.ceiling': 'Soffitto',
  'look.peak.comet': 'Cometa',
  'look.peak.drip': 'Goccia',
