...
const eq: Partial<Dictionary> = {
  ...
  'graph.styleName.beams': 'Fasci di luce',
  'graph.styleName.sparkbars': 'Barre di scintille',
  'graph.styleName.glitchbars': 'Barre glitch',
  'graph.styleName.orb': 'Sfera',
  'graph.styleName.kaleido': 'Caleidoscopio',
  'graph.styleName.helix': 'Elica',
  'graph.styleName.mesh': 'Reticolo',
