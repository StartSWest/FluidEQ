...
const eq: Partial<Dictionary> = {
  ...
  'eq.layouts.clearWarning':
    'Imposta il guadagno di ogni banda a 0 dB. Mantieni numero di bande, frequenze, Q, modalità EQ e preamplificatore attuali.',
  ...
  'graph.scene.frameRateHint':
    'Ogni quanto vengono disegnate le visualizzazioni: a ogni fotogramma dello schermo, o limitate per non affaticare la GPU',
  ...
  'graph.scene.locked':
    'Parte di FluidEQ Plus. Scegli questo look per vedere come sbloccarlo.',
  'graph.style.next': 'Stile successivo',
  'graph.style.previous': 'Stile precedente',
  'graph.style.search': 'Cerca stili',
  'graph.picker.label': 'Stili e visualizzazioni',
  'graph.picker.search': 'Cerca stili e visualizzazioni',
  'graph.picker.styles': 'Stili',
  'graph.picker.plus': 'Visualizzazioni Plus',
  'graph.picker.all': 'Tutti',
  'graph.picker.yours': 'Tuoi',
  'graph.picker.filterStyles': 'Filtra stili',
  'graph.picker.filterPlus': 'Filtra visualizzazioni',
  ...
  'output.apoMissingBody':
    'FluidEQ non può modificare {device} finché non lo attivi nel Selettore dispositivi di Equalizer APO e riavvii Windows.',
  'output.apoConfigure': 'Attiva nel Selettore dispositivi',
