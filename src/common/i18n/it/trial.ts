const trial = {
  'trial.free.title': 'FluidEQ è gratuito. Plus è facoltativo.',
  'trial.free.body':
    'Il tuo equalizzatore, la riproduzione musicale, i preset e i visualizzatori gratuiti restano gratuiti. Plus aggiunge funzioni facoltative.',
  ...
  'trial.ended.paid':
    'Un abbonamento Plus a pagamento serve solo se vuoi continuare a usare le funzioni Plus.',
  'trial.ended.free': 'Continua gratis',
  'trial.ended.plans': 'Vedi i piani Plus',
  'trial.error.offline':
  ...
  'trial.settings.save': 'Salva impostazione dell’offerta',
