...
const dsp = {
  ...
  'dsp.gameMode.hint':
    'गेम मोड अनावश्यक बफ़र हटाता है और मिनिमम-फेज़ EQ इस्तेमाल करता है। सक्रिय प्रभाव फिर भी देरी जोड़ सकते हैं। गेमिंग प्रीसेट इसे चालू करते हैं; प्रीसेट बदले बिना इसे बंद कर सकते हैं।',
  ...
  'dsp.engineDown':
    'नेटिव ऑडियो इंजन शुरू नहीं हो सका, इसलिए हर DSP चरण बंद है। नीचे कुछ भी आपके संगीत को प्रोसेस नहीं कर रहा और नियंत्रण निष्क्रिय हैं; प्लेबैक पर कोई असर नहीं पड़ता। FluidEQ को फिर से शुरू करने पर आमतौर पर यह ठीक हो जाता है।',
  'dsp.presets': 'प्रीसेट',
  ...
  'dsp.normalizer.description':
    'पूरे स्रोत को एक बार मापकर एक्साइटर और EQ से पहले एक स्थिर, स्टीरियो-लिंक्ड गेन लगाता है। कोई पंपिंग या चलता RMS फ़ॉलोअर नहीं।',
  ...
  'dsp.crossfade.description':
    'नॉर्मलाइज़ेशन के बाद, एक्साइटर और EQ से पहले आउटगोइंग और इनकमिंग ट्रैक को ओवरलैप करता है।',
  ...
  'dsp.eqPhase.minimum': 'मिनिमम',
  'dsp.eqPhase.linear': 'लीनियर',
  'dsp.eqPhase.linearLatency': 'लीनियर (+{ms} ms)',
  ...
  'dsp.bassForge.isolateOn':
    'मूल सिग्नल हटाया गया — केवल वही सुनाई दे रहा है जो बास फ़ोर्ज जोड़ता है।',
  ...
  'dsp.master.matchedBypassHint':
    'आउटपुट से {gain} dB की बढ़त वापस हटा देता है, इसलिए मास्टर को चालू-बंद करने पर आवाज़ नहीं, ध्वनि की तुलना होती है। लिमिटिंग दोनों में एक जैसी रहती है — बदलता सिर्फ़ स्तर है।',
  ...
  'dsp.surround.roomHint':
    'कमरा हर चैनल को आपके सिर के चारों ओर रखता है, इसलिए चालू रहने तक वह सभी चैनल लेता है। कमरा बंद करते ही आपका चुनाव वापस आ जाता है।',
  ...
  'dsp.room.speaker.pick': 'सेटिंग बदलने के लिए एक स्पीकर चुनें',
  ...
  'dsp.room.speaker.noteSubUnfed':
    'स्टीरियो में सबवूफ़र चैनल नहीं होता, इसलिए इस लेवल के पास बदलने को कुछ नहीं है। बास सब को भेजा गया हो तो स्पीकरों का निचला हिस्सा फिर भी यहीं से बजता है।',
  ...
  'dsp.room.tune.bassCentre': 'बास और सेंटर',
  ...
  'dsp.room.resetHint':
    'रेफ़रेंस कमरे पर वापसी, जैसा वह आता है; इस पेज का हर विकल्प रीसेट हो जाता है, सुनने वाले के विकल्प भी। सिर्फ़ पावर स्विच जैसा है वैसा रहता है।',
