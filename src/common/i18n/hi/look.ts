...
const look: Partial<Dictionary> = {
  'look.textureStyle': 'बनावट',
  'look.texture.none': 'सादा',
  'look.texture.hatch': 'तिरछी रेखाएँ',
  'look.texture.crosshatch': 'क्रॉस-हैच',
  'look.texture.rules': 'रेखाएँ',
  'look.texture.pinstripe': 'पतली धारियाँ',
  'look.texture.dots': 'बिंदु',
  'look.texture.grid': 'ग्रिड',
  'look.texture.weave': 'बुनाई',
  'look.texture.scales': 'शल्क',
  'look.texture.chevron': 'शेवरॉन',
  'look.texture.static': 'दाना',
  'look.texture.image': 'तस्वीर',
  'look.texture.replace': 'तस्वीर बदलें',
  'look.texture.tooBig':
    'यह तस्वीर सहेजने के लिए बहुत बड़ी है। कोई छोटी आज़माएँ।',
  'look.texture.unreadable': 'यह फ़ाइल तस्वीर के रूप में नहीं पढ़ी जा सकी।',
  'look.tilt': 'ढलान',
  'look.tiltHint':
    'प्रति ऑक्टेव डेसिबल। प्रदर्शन को ट्रेबल की ओर झुकाता है, ताकि संतुलित मिक्स सपाट दिखे।',
  'look.tiltValue': '{value} dB/ऑक्टेव',
  'look.channels': 'चैनल',
  'look.channels.joined': 'एक साथ',
  'look.channels.split': 'बायाँ और दायाँ',
  ...
  'look.attack': 'अटैक',
  'look.release': 'रिलीज़',
  'look.releaseHint': 'गिरने से पहले शिखर कितनी देर ठहरे',
  'look.drawnAs': 'चित्रण',
  'look.filled': 'भरा हुआ',
  ...
  'look.needsRainbow': 'इंद्रधनुष मोड चाहिए।',
  'look.glowNotForForm': 'इस आकार में चमक नहीं है।',
  'look.rainbowBorder': 'इंद्रधनुषी बॉर्डर',
  'look.rainbowBorderHint':
    'पूरे रंग चक्र में घूमते रंग से ग्राफ़ को घेरता है।',
  'look.borderWeight': 'बॉर्डर की मोटाई',
  'look.litPeaks': 'चमकते शिखर',
  'look.name': 'नाम',
