...
const look: Partial<Dictionary> = {
  ...
  'look.glowNotForForm': 'इस रूप में चमक नहीं है।',
  ...
  'look.peakStyle': 'निशान',
  'look.peak.fall': 'गिरावट',
  'look.peak.ghost': 'छाया',
  'look.peak.ripple': 'लहर',
  'look.peak.sparks': 'चिंगारी',
  'look.peak.beam': 'किरण',
  'look.peak.ceiling': 'छत',
  'look.peak.comet': 'धूमकेतु',
  'look.peak.drip': 'बूँद',
  'look.peak.bead': 'डिब्बा',
  'look.peak.cap': 'टोपी',
  'look.peak.ring': 'छल्ला',
  'look.peak.spark': 'चिंगारी',
  'look.peak.chevron': 'शेवरॉन',
  'look.peak.halo': 'प्रभामंडल',
  'look.peak.pin': 'पिन',
  ...
  'support.game.howTo':
    'संगीत चलाएँ। जब कोई शिखर बीच की रेखा पर आए, तो पेट पर टैप करें या स्पेस दबाएँ। रेनबो मोड खोलने के लिए ×10 तक पहुँचें।',
  'support.game.thanks':
  ...
  'support.game.shareUnlock':
    'गेम खेलकर या अपने योगदान की पुष्टि करके रेनबो मोड खोलें और इस कार्ड को इंद्रधनुषी रंग दें।',
  ...
  'support.game.euphoriaHint':
    'इंद्रधनुषी रंग, और ग्राफ़, मीटर व वेव 30 फ़्रेम प्रति सेकंड के बजाय आपकी स्क्रीन की पूरी रिफ़्रेश दर पर। चालू या बंद करने के लिए दबाएँ।',
  ...
  'support.contributed': 'मैंने योगदान दिया — रेनबो मोड चालू करें',
  'support.rainbowHint':
    'योगदान दे चुके हैं? “मैंने योगदान दिया” से रेनबो मोड तुरंत चालू करें — इसके रंग, और ग्राफ़ व मीटर में ज़्यादा स्मूद हरकत। ×10 तक पहुँचना ज़रूरी नहीं है।',
  'support.thanks':
    'धन्यवाद — रेनबो मोड खुल गया है और आपके पेट को सितारा और नाच मिल गया है।',
