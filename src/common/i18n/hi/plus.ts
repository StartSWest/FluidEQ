const plus = {
  ...
  'plus.welcome.body':
    'खाते से आप गैलरी देख सकते हैं, छोटे डेमो चला सकते हैं और स्टूडियो में एक सीन बना सकते हैं। दृश्य डाउनलोड करके रखने, पूरे चलाने, अपने स्टाइल में जोड़ने और अपने बनाए सीन को कहीं भी ले जाने के लिए Plus आवश्यक है।',
