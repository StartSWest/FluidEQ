...
const eq: Partial<Dictionary> = {
  ...
  'squigImport.replaceBody':
    'EQ बदलने से उसके मौजूदा बैंड हट जाएंगे। इसके बजाय इस इंपोर्ट को अलग करेक्शन कर्व के रूप में लागू कर सकते हैं। इंपोर्ट मोड बदलने से पिछला इंपोर्ट हट जाता है।',
