...
const eq: Partial<Dictionary> = {
  ...
  'squigImport.intro':
    'Squiglink कैलकुलेटर का इस्तेमाल करें और उसका एक्सपोर्ट यहाँ पेस्ट करें। EQ के रूप में लागू करने से संपादन योग्य बैंड बदल जाते हैं। कर्व के रूप में लागू करने से OPRA की तरह हेडफ़ोन करेक्शन बदलता है, जिसकी अपनी तीव्रता और स्विच होते हैं; आपके EQ बैंड नहीं बदलते।',
  ...
  'squigImport.replaceBody':
    'EQ बदलने से उसके मौजूदा बैंड हट जाएंगे। इसके बजाय इस आयात को अलग करेक्शन कर्व के रूप में लागू कर सकते हैं। आयात मोड बदलने से पिछला आयात हट जाता है।',
