...
const dsp = {
  ...
  'dsp.normalizer.description':
    'Один раз измеряет весь источник и применяет единое связанное стереоусиление перед эксайтером и EQ. Без пампинга и подвижного RMS-слежения.',
  ...
  'dsp.normalizer.liveMeterHint':
    'Фактические пики сэмплов непосредственно до и после нормализации. Нулевая метка — 0 дБFS.',
  ...
  'dsp.denoise.waiting': 'Включите трек из Библиотеки, чтобы измерить его.',
  ...
  'dsp.eqSave.hint': 'Сохраняет стойку как есть.',
  ...
  'dsp.eqShare.hint': 'Сохраняет стойку файлом, который смогут открыть другие.',
  ...
  'dsp.bassForge.isolateOn':
    'Исходный сигнал убран — слышно только то, что добавляет Кузница баса.',
  ...
  'dsp.master.matchedBypassHint':
    'Снимает с выхода {gain} дБ подъёма, поэтому включение и выключение Мастера сравнивает звук, а не громкость. Ограничение в обоих случаях одинаковое — меняется только уровень.',
  'dsp.surround.title': 'Surround',
  'dsp.surround.onHint':
    'Прогоняет стойку по каждому каналу выхода 5.1 или 7.1, как настроено в Windows, с одним решением по уровню для всех.',
  'dsp.surround.offHint':
    'Только передняя пара: остальные каналы surround-выхода проходят через стойку нетронутыми.',
