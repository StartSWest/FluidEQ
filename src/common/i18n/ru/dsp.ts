...
const dsp = {
  ...
  'dsp.idle':
    'DSP включается, когда музыка воспроизводится из Библиотеки. Spotify, YouTube и другие приложения не обрабатываются.',
  'dsp.unavailable':
  ...
  'dsp.bassPunch.isolateHint':
    'Слушать только формирование, которое делает этот этап.',
  'dsp.bassPunch.isolateOn':
    'Исходный сигнал убран — слышно только то, что добавляет Punch. Тишина, когда все регуляторы в покое.',
