...
const dsp = {
  ...
  'dsp.room.savedRooms': 'Сохранённые комнаты',
  'dsp.room.saveRoom': 'Сохранить комнату…',
  'dsp.room.saveTitle': 'Сохранить эту комнату',
  'dsp.room.saveHint':
    'Комната как есть — размер, стены, расстояние, центр, саб и расположение колонок — сохраняется под этим именем. Голова остаётся вашей.',
  'dsp.room.savePlaceholder': 'Название комнаты',
  'dsp.room.applyRoom': 'Использовать эту комнату',
  'dsp.room.roomApplied': 'Эта комната сейчас используется',
  'dsp.room.deleteRoom': 'Удалить комнату',
  'dsp.room.groupRoom': 'Комната',
  ...
  'dsp.room.headHint':
    'Голова, через которую строится комната. Выберите ту, с которой звуки оказываются перед вами, а не внутри головы.',
  ...
  'dsp.room.groupListener': 'Слушатель',
