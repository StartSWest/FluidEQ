...
const dsp = {
  ...
  'dsp.normalizer.liveGuidance':
    'Выравнивание изучает уровень программы, затем постепенно регулирует его. На тихих фрагментах усиление удерживается; увеличение ограничено 6 дБ и доступным запасом по пикам. Достижение цели не гарантируется. После смены источника без паузы выключите и снова включите выравнивание для нового анализа. Уже имеющиеся искажения не устраняются.',
  ...
  'dsp.normalizer.liveHonesty':
    'Громкость определяется за три секунды и регулируется плавно. Тихие фрагменты сохраняют усиление; защита пиков остаётся активной. Искажения исходного звука не исправляются.',
  'dsp.title': 'DSP',
  'dsp.scopeNotice':
