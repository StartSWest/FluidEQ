const leaderboard = {
  ...
  'leaderboard.card.body':
    'Кто слушает больше всех среди участников Plus. Выключено, пока вы не присоединитесь. Если присоединитесь, приложение отправляет одно число за каждый день — целые минуты проигранной музыки, не больше шестнадцати часов — с его датой и случайным идентификатором этого компьютера и обновляет его, когда вы возвращаетесь к компьютеру или открываете таблицу лидеров. Ваше имя и итоги видны всем, кто вошёл в аккаунт. Никогда — что вы слушали и откуда.',
