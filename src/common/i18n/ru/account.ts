const account = {
  ...
  'account.checking': 'Проверяем аккаунт…',
  ...
  'account.plus.pitch':
    'Визуализаторы, которых нет больше нигде, Студия, чтобы создавать свои, таблица лидеров — и каждая новая функция отныне сначала для участников. Всё, что бесплатно сегодня, остаётся бесплатным.',
