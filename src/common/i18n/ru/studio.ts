const studio = {
  ...
  'studio.locked.earn':
    'Публикуйте одну сцену в месяц — и следующий месяц Plus бесплатный.',
  ...
  'studio.plus.oneProject':
    'Без Plus Студия хранит один проект. Опубликуйте сцену, чтобы получить следующий месяц бесплатно, или возьмите Plus — тогда их будет сколько угодно.',
