const studio = {
  'studio.notes.failed':
    'Не удалось сохранить описание проекта. Попробуйте ещё раз.',
  ...
  'studio.picture.view': 'Увеличить {name}',
  'studio.picture.previous': 'Предыдущее изображение',
  'studio.picture.next': 'Следующее изображение',
  'studio.picture.position': '{index} из {count}',
  'studio.picture.all': 'Все изображения',
  'studio.picture.close': 'Закрыть',
  'studio.picture.zoomIn': 'Приблизить',
  'studio.picture.zoomOut': 'Отдалить',
  'studio.picture.fit': 'Вписать',
  ...
  'studio.locked.body':
    'Здесь рождаются сцены FluidEQ — и здесь может появиться ваша.',
  'studio.locked.write':
    'Пишите код рядом с экраном, который пересобирается при каждом сохранении',
  'studio.locked.test': 'Включите музыку и смотрите, сколько стоит отрисовка',
  'studio.locked.publish': 'Опубликуйте её в галерее для всех участников',
  'studio.locked.keptOne': 'Ваш проект там, где вы его оставили, в',
  'studio.locked.keptMany': 'Ваши {count} проекта там, где вы их оставили, в',
  'studio.locked.earn':
    'Опубликованная вами сцена даёт месяц Plus, как только её одобрят.',
  'studio.plus.oneFolder':
    'Без Plus открывается первая; остальные остаются в списке с замком, для Plus.',
  'studio.plus.lockedProject':
    'С Plus этот проект тоже откроется; без Plus Студия хранит один.',
  'studio.plus.oneProject':
    'Без Plus Студия хранит один проект. Опубликуйте сцену — как только её одобрят, следующий месяц бесплатный, или возьмите Plus, тогда их будет сколько угодно.',
  ...
  'studio.project.groupOfficial': 'Сцены FluidEQ, чтобы заглянуть внутрь',
  'studio.project.inspect': 'Заглянуть внутрь сцены FluidEQ…',
  ...
  'studio.project.rename': 'Переименовать {name}…',
  'studio.rename.title': 'Переименовать проект',
  'studio.rename.lead':
    'Сцена и её папка получат новое имя. FluidEQ отпустит файлы, пока папка переименовывается, а затем снова откроет сцену.',
  'studio.rename.where': 'Папка',
  'studio.rename.save': 'Переименовать',
  'studio.rename.saving': 'Переименование…',
  'studio.rename.exists': 'Рядом уже есть папка {name}. Выберите другое имя.',
  'studio.rename.failed':
    'Не удалось переименовать папку. Закройте программы, которые используют её файлы, и попробуйте ещё раз.',
  ...
  'studio.publish.category': 'Категории',
  ...
  'studio.publish.point3':
    'Вы можете снять сцену с публикации, чтобы прекратить новые загрузки. Уже скачанные копии останутся доступны с Plus.',
  ...
  'studio.publish.officialCopy':
    'Эта сцена почти целиком повторяет одну из сцен FluidEQ. Берите из них идеи, но сделайте сцену своей, прежде чем публиковать её.',
  ...
  'studio.share.point2':
    'Каждый лайк от другого участника приносит вам очки в таблице лидеров.',
  'studio.share.point3':
  ...
  'studio.export.officialCopy':
    'Эта сцена почти целиком повторяет одну из сцен FluidEQ. Берите из них идеи, но сделайте сцену своей, прежде чем экспортировать её.',
  'studio.inspect.title': 'Сцена FluidEQ — чтобы заглянуть внутрь',
  'studio.inspect.body':
    'Посмотрите, как она сделана, и возьмите идеи для своих сцен. Пробуйте здесь любые изменения; её нельзя добавить в оформления, опубликовать или экспортировать.',
  'studio.inspect.locked':
    'Это сцена FluidEQ, открытая, чтобы заглянуть внутрь. Её нельзя добавить в оформления, опубликовать или экспортировать.',
  ...
  'studio.idea.pet.text':
    'Фото моего питомца, живое под музыку. Он мягко дышит с басами, на каждый удар по контуру пробегает тонкая кайма света, цвета теплеют со средними, а с высокими вокруг поднимаются крошечные искры. На каждый яркий момент позади него взрывается облако конфетти, каждый раз нового цвета. В тишине он только медленно дышит. Ползунки для свечения, искр и того, насколько сильно он двигается. Вокруг приложения в режиме «Атмосфера»: маленькие следы лапок и сердечки, проплывающие мимо.',
  'studio.idea.city.label': 'Неоновый город',
  'studio.idea.city.text':
    'Неоновый город ночью, после дождя. Силуэт города — мой спектр: каждая башня растёт со своей частью музыки, басы слева, высокие справа, там, где их ставят высота и положение моей волны. Окна загораются со средними, огни на крышах мигают на каждый удар, а на каждый яркий момент по мосту на переднем плане проезжает поезд. Мокрая улица отражает всё и рябит по форме волны. В тишине медленно ползёт только поток машин. Ползунки для дождя, окон и неонового свечения. Вокруг приложения в режиме «Атмосфера»: мягкие огни города, плывущие, как боке.',
  'studio.idea.sea.label': 'Глубокое море',
  'studio.idea.sea.text':
    'Глубина океана ночью. Светящаяся медуза парит внутри моей волны: её купол пульсирует с басами, а длинные щупальца колышутся со средними, пока планктон искрится с высокими, а слабые лучи света опускаются сверху. Маленькая стайка рыб проносится мимо на каждый удар, а на каждый яркий момент в глубине скользит тень кита. В тишине всё замедляется и спокойно дрейфует. Ползунки для свечения, глубины и числа медуз. Вокруг приложения в режиме «Атмосфера»: медленно поднимающиеся пузырьки.',
  'studio.idea.vinyl.label': 'Винил',
  'studio.idea.vinyl.text':
    'Проигрыватель, вид сверху, в тёплой полутёмной комнате. Пластинка вращается с ровной скоростью, а её дорожки загораются кольцами: басы у этикетки, высокие у края. Игла светится и сыплет мелкими искрами на каждый удар, цвета этикетки меняются со средними, а пылинки кружатся в свете лампы с высокими. На каждый яркий момент по пластинке к краю бежит кольцо света. В тишине она продолжает вращаться в мягком свете. Ползунки для скорости вращения, свечения и пыли. Вокруг приложения в режиме «Атмосфера»: ноты, всплывающие вверх.',
  'studio.idea.fire.label': 'Костёр',
  'studio.idea.fire.text':
    'Костёр в сосновом лесу под звёздами. Пламя — мой спектр, оно стоит внутри моей волны: каждый язык огня взлетает со своей частью музыки. Угольки взлетают на тарелках, поленья краснеют с басами, деревья вокруг ловят отблески огня со средними, а звёзды мерцают с высокими. На каждый яркий момент в ночь поднимается спираль искр. В тишине он горит низко и ровно. Ползунки для размера огня, угольков и дыма. Вокруг приложения в режиме «Атмосфера»: блуждающие светлячки и несколько поднимающихся искр.',
  'studio.idea.sunset.label': 'Золотой час',
  'studio.idea.sunset.text':
    'Горная долина в золотой час. Далёкие хребты — мой спектр: они поднимаются и опускаются со своей частью музыки внутри моей волны и тают в дымке с расстоянием. Низкое солнце мягко растёт с басами, облака розовеют со средними, а река внизу блестит с высокими. На каждый яркий момент перед солнцем проносится стая птиц, каждый раз по-новому. В тишине плывут только облака. Ползунки для высоты солнца, дымки и облаков. Вокруг приложения в режиме «Атмосфера»: изредка парящие птицы.',
  ...
  'studio.signal.live': 'Ваша музыка',
  'studio.signal.silence': 'Тишина',
  'studio.signal.bass': 'Басы',
  'studio.signal.mid': 'Средние',
  'studio.signal.treble': 'Высокие',
  'studio.signal.beat': 'Удар',
  'studio.signal.accent': 'Акцент',
  'studio.signal.showcase': 'Тестовый микс',
  ...
  'studio.signalHint.bass':
    'Только бас того, что играет. Показывает, что движется с низами.',
  'studio.signalHint.mid':
    'Только средние частоты того, что играет: голоса и аккорды.',
  'studio.signalHint.treble':
    'Только высокие частоты того, что играет: тарелки и воздух.',
  ...
  'studio.settings.ambientOff':
    'Переключите вид окна на «Атмосферу», чтобы увидеть их.',
  ...
  'studio.settings.carries':
    'Сохраняется в сцене, когда вы отпускаете: ваши оформления и галерея тоже это получат.',
  'studio.settings.saving': 'Сохраняем в сцене…',
  'studio.settings.saved': 'Сохранено в сцене.',
  'studio.settings.savedLook': 'Сохранено в сцене и в вашем оформлении.',
  ...
  'studio.size.narrow': 'Узкий',
  'studio.size.wide': 'Широкий',
  'studio.size.full': 'Во весь экран',
  'studio.size.exit': 'Выйти из полноэкранного режима',
  'studio.wave.title': 'Волна на графике',
  'studio.wave.hint':
    'Сохраняется в сцене и публикуется вместе с ней, так что она открывается такой, какой вы её оставили. Пользователи могут менять это в меню «Вид» на графике и вернуть вашу настройку. Проверьте крайние значения: низкую волну или поднятую до середины.',
  ...
  'studio.grid.label': 'Показать сетку графика',
  'studio.grid.hint':
  ...
  'studio.cost.reading': '{ms} мс · {fps} fps · {size} %',
  ...
  'studio.problem.non-ascii':
    'Вне комментариев разрешены только простые символы ASCII.',
  'studio.problem.while':
    'Циклы while запрещены. Используйте цикл for с фиксированным числом шагов.',
  'studio.problem.do':
    'Циклы do запрещены. Используйте цикл for с фиксированным числом шагов.',
  'studio.problem.main':
    'Сцена не должна определять main(). Его пишет FluidEQ.',
  ...
  'studio.problem.bad-id':
    'id должен состоять из 2–48 строчных латинских букв, цифр и дефисов.',
  'studio.problem.names-missing': 'Нужно название на английском.',
  'studio.problem.name-too-long': 'Название длиннее 40 символов.',
  'studio.problem.bad-fallback':
    'fallbackStyle — не одно из оформлений FluidEQ.',
  'studio.problem.bad-swatch': 'swatch нужны 2–4 цвета вида #00e5cf.',
