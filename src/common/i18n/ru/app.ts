...
const app: Partial<Dictionary> = {
  ...
  'app.processes.what.desktop':
    'Визуализатор Plus в роли фона рабочего стола монитора, отдельно от этого окна: по одному на каждый монитор, где он показан. Встаёт на паузу, пока полноэкранное приложение закрывает этот монитор или ПК заблокирован.',
  'app.processes.name.desktopHost': 'Помощник визуализатора рабочего стола',
  'app.processes.what.desktopHost':
    'Помещает визуализатор рабочего стола этого монитора за значки и сообщает ему, когда экран закрывает полноэкранное приложение. По одному на каждый монитор, где он показан.',
