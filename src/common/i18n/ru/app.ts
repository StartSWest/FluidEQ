...
const app: Partial<Dictionary> = {
  ...
  'app.processes.name.shareCapture': 'Захват аудио',
  'app.processes.what.shareCapture':
    'Захватывает то, что играет этот ПК, до эквалайзера — для вкладки «Поделиться аудио», второго выхода и функции «Умный EQ». Работает, только пока что-то из этого используется.',
  'app.processes.name.sharePlayback': 'Воспроизведение общего аудио',
  'app.processes.what.sharePlayback':
    'Воспроизводит звук, которым другой FluidEQ делится с этим ПК. Работает, только пока вы его слушаете.',
  'app.processes.name.volume': 'Громкость системы',
  'app.processes.what.volume':
    'Следит за громкостью и отключением звука Windows для регуляторов громкости FluidEQ и меняет громкость, когда вы двигаете один из них. Работает, только пока регулятор на экране.',
  'app.processes.name.games': 'Распознавание игр',
  'app.processes.what.games':
    'Сообщает FluidEQ, какая программа на переднем плане, чтобы игра получала свой звук, как только вы на неё переключаетесь. Работает, только пока у игры есть свой звук или открыта страница «Пресеты игр».',
  'app.processes.name.outputs': 'Наблюдение за выходами',
  'app.processes.what.outputs':
    'Слышит, когда Windows сообщает, что выход подключили, отключили или изменили, чтобы FluidEQ переключался на профиль этого выхода, даже когда окно скрыто. Работает, пока работает FluidEQ.',
  ...
  'app.tray.recoverWindow': 'Восстановить окно',
  ...
  'sidebar.state.on': '{engine} · вкл.',
  'sidebar.state.off': 'Выключен',
  'sidebar.state.notOnOutput': 'Не на этом выходе',
  'sidebar.preamp': 'Предусиление',
  'sidebar.autoLabel': 'АВТО',
