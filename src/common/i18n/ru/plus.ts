const plus = {
  ...
  'plus.welcome.body':
    'Аккаунт позволяет просматривать галерею, смотреть короткие демонстрации и сделать одну сцену в Студии. Для скачивания и хранения сцен, полного воспроизведения, добавления в свои стили и того, чтобы сделанное вами попало куда угодно, нужен Plus.',
