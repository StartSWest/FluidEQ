const plus = {
  ...
  'plus.gallery.sort.liked': 'Самые любимые',
  ...
  'plus.welcome.body':
    'Аккаунт позволяет просматривать галерею и смотреть короткие демонстрации. Для скачивания и хранения сцен, полного воспроизведения, добавления в свои стили, создания собственных сцен в Студии и того, чтобы сделанное вами попало куда угодно, нужен Plus.',
