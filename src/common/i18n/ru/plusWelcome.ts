const plusWelcome = {
  ...
  'plusWelcome.title': 'Добро пожаловать в Plus',
  'plusWelcome.lead':
    'Подписка активна. Спасибо — именно она позволяет развивать FluidEQ. Вот что только что открылось.',
  ...
  'plusWelcome.board.line':
    'Поднимайтесь за счёт часов прослушивания и лайков ваших сцен.',
  'plusWelcome.note':
    'Plus работает не более чем на пяти ваших компьютерах, а всё бесплатное таким и остаётся.',
