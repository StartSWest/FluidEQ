const engineHealth = {
  ...
  'engineHealth.neverRanBody':
    'Движок установлен и включён на {device}, но Windows ни разу не загрузил его на этом компьютере — перезапуск звука его не вернёт. FluidEQ уже исправил всё, до чего может дотянуться; если ничего не изменилось, ему мешает ваша защитная программа или драйвер звуковой карты. Тем временем звук обрабатывает Equalizer APO.',
