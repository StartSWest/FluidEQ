...
const look: Partial<Dictionary> = {
  'look.connectingLine': 'Соединительная линия',
  'look.peak.blink': 'Мигание в такт',
  'look.peakFill': 'Заливка пиков',
  'look.peak.live': 'Пики в реальном времени',
  'look.peakLayer': 'Положение пиков',
  'look.peakFront': 'Перед волной',
  'look.peakBehind': 'За волной',
  ...
  'look.peak.fall': 'Спад',
  'look.peak.ghost': 'Призрак',
  'look.peak.ripple': 'Волна',
  'look.peak.sparks': 'Искры',
  'look.peak.beam': 'Луч',
  'look.peak.ceiling': 'Потолок',
  'look.peak.comet': 'Комета',
  'look.peak.drip': 'Капля',
