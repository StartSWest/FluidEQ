...
const look: Partial<Dictionary> = {
  'look.textureStyle': 'Текстура',
  'look.texture.none': 'Без узора',
  'look.texture.hatch': 'Штриховка',
  'look.texture.crosshatch': 'Перекрёстная штриховка',
  'look.texture.rules': 'Линии',
  'look.texture.pinstripe': 'Полоски',
  'look.texture.dots': 'Точки',
  'look.texture.grid': 'Сетка',
  'look.texture.weave': 'Плетение',
  'look.texture.scales': 'Чешуя',
  'look.texture.chevron': 'Шеврон',
  'look.texture.static': 'Зерно',
  'look.texture.image': 'Картинка',
  'look.texture.replace': 'Заменить картинку',
  'look.texture.tooBig':
    'Эта картинка слишком большая, чтобы её сохранить. Выберите поменьше.',
  'look.texture.unreadable': 'Не удалось прочитать этот файл как картинку.',
  'look.tilt': 'Наклон',
  'look.tiltHint':
    'Децибелы на октаву. Наклоняет отображение к верхам: сбалансированный микс выглядит ровным.',
  'look.tiltValue': '{value} дБ/окт',
  'look.channels': 'Каналы',
  'look.channels.joined': 'Вместе',
  'look.channels.split': 'Левый и правый',
  ...
  'look.glowNotForForm': 'У этой формы нет свечения.',
  ...
  'support.game.howTo':
    'Включите музыку и нажимайте на питомца или Пробел, когда пик достигает центральной линии. Достигните ×10, чтобы открыть режим «Радуга».',
  'support.game.thanks':
  ...
  'support.game.euphoriaHint':
    'Радужные цвета, а график, индикаторы и волна рисуются с полной частотой обновления экрана, а не 30 кадров в секунду. Нажмите, чтобы включить или выключить.',
  ...
  'support.contributed': 'Я поддержал — включить режим «Радуга»',
  'support.rainbowHint':
    'Уже поддержали? Включите режим «Радуга» сразу кнопкой «Я поддержал» — его цвета и более плавное движение графика и индикаторов. Достигать ×10 не нужно.',
  'support.thanks':
    'Спасибо — режим «Радуга» открыт, а у питомца теперь есть звезда и танец.',
