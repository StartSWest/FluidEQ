...
const app: Partial<Dictionary> = {
  ...
  'app.status.checking': 'Comprobando el motor de audio…',
  'app.status.error': 'El motor de audio no responde',
  ...
  'app.processes.what.desktop':
    'Un visualizador de Plus dibujado como fondo de escritorio de un monitor, aparte de esta ventana: uno por cada monitor que lo muestra. Se pausa mientras las ventanas cubren ese monitor o el PC está bloqueado.',
  'app.processes.name.desktopHost': 'Ayudante del visualizador de escritorio',
  'app.processes.what.desktopHost':
    'Coloca el visualizador de escritorio de ese monitor detrás de los iconos y le avisa cuando las ventanas cubren la pantalla. Uno por cada monitor que lo muestra.',
  'app.processes.name.shareCapture': 'Captura de audio',
  ...
  'app.processes.name.games': 'Detección de juegos',
  'app.processes.what.games':
    'Le dice a FluidEQ qué programa está en primer plano, para que un juego tenga su propio sonido en cuanto cambias a él. Solo funciona mientras un juego tiene sonido propio o la página Presets de juego está abierta.',
  'app.processes.name.outputs': 'Vigilante de salidas',
  'app.processes.what.outputs':
    'Escucha cuando Windows avisa de que una salida se conectó, se desconectó o cambió, para que FluidEQ pase al perfil de esa salida aunque su ventana esté oculta. Funciona mientras FluidEQ esté abierto.',
  ...
  'app.processes.name.libraryScan': 'Escaneo de la biblioteca',
  ...
  'engine.fluid.l4':
    'Equalizer APO se desactiva mientras este motor funciona y se restaura tal cual si vuelves a él',
  ...
  'engine.close': 'Cerrar',
  'engine.switched': 'Cambiado a {engine}',
  ...
  'app.tray.recoverWindow': 'Recuperar la ventana',
  ...
  'restart.action': 'Reiniciar el audio',
  ...
  'sidebar.state.on': '{engine} · activo',
  'sidebar.state.off': 'Apagado',
  'sidebar.state.notOnOutput': 'No está en esta salida',
  ...
  'config.title.fluid': 'Configuración del Motor FluidEQ',
  'config.lede':
  ...
  'config.absent.fluid':
    'FluidEQ todavía no ha escrito la configuración del Motor FluidEQ.',
  ...
  'config.status.notIncluded.fluid':
    'El Motor FluidEQ no está leyendo esta configuración. No se aplica nada de lo que hay debajo.',
  'config.status.engineOff':
    'El EQ del sistema está apagado: esta configuración no nombra ninguna salida, así que Equalizer APO no aplica nada de ella.',
  'config.status.engineOff.fluid':
    'El EQ del sistema está apagado: esta configuración no nombra ninguna salida, así que el Motor FluidEQ no aplica nada de ella.',
  'config.status.active':
    'Activa: Equalizer APO está aplicando esta configuración.',
  'config.status.active.fluid':
    'Activa: el Motor FluidEQ está aplicando esta configuración.',
  'config.outputsAria': 'Salidas en la configuración de Equalizer APO',
  'config.outputsAria.fluid': 'Salidas en la configuración del Motor FluidEQ',
  ...
  'config.hint.saving.fluid':
    'Al guardar se escribe el archivo; el Motor FluidEQ lo recoge.',
  'config.edit': 'Editar',
  ...
  'settings.group.visualizer': 'El visualizador',
