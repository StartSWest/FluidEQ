...
const look: Partial<Dictionary> = {
  'look.connectingLine': 'Línea de conexión',
  'look.peak.blink': 'Destello al ritmo',
  ...
  'look.peak.fall': 'Caída',
  'look.peak.ghost': 'Fantasma',
  'look.peak.ripple': 'Onda expansiva',
  'look.peak.sparks': 'Chispas',
  'look.peak.beam': 'Haz',
  'look.peak.ceiling': 'Techo',
  'look.peak.comet': 'Cometa',
  'look.peak.drip': 'Goteo',
  'look.peak.bead': 'Caja',
  'look.peak.cap': 'Tapa',
  'look.peak.ring': 'Anillo',
  'look.peak.spark': 'Chispa',
  'look.peak.chevron': 'Galón',
  'look.peak.halo': 'Halo',
  'look.peak.pin': 'Alfiler',
