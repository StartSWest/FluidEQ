...
const look: Partial<Dictionary> = {
  ...
  'look.texture.hatch': 'Rayado',
  'look.texture.crosshatch': 'Trama cruzada',
  'look.texture.rules': 'Líneas',
  'look.texture.pinstripe': 'Raya fina',
  'look.texture.dots': 'Puntos',
  'look.texture.grid': 'Cuadrícula',
  'look.texture.weave': 'Tejido',
  'look.texture.scales': 'Escamas',
  'look.texture.chevron': 'Galón',
  'look.texture.static': 'Grano',
  'look.texture.image': 'Imagen',
  'look.texture.replace': 'Cambiar imagen',
  'look.texture.tooBig':
    'Esa imagen es demasiado grande para guardarla. Prueba con una más pequeña.',
  'look.texture.unreadable': 'No se pudo leer ese archivo como imagen.',
  'look.tilt': 'Pendiente',
  'look.tiltHint':
    'Decibelios por octava. Inclina la vista hacia los agudos, para que una mezcla equilibrada se vea plana.',
  'look.tiltValue': '{value} dB/oct',
  'look.channels': 'Canales',
  'look.channels.joined': 'Unidos',
  'look.channels.split': 'Izquierdo y derecho',
