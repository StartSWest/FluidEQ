...
const karaoke: Partial<Dictionary> = {
  ...
  'karaoke.transport.mixSettings': 'Ajustes de mezcla',
  'karaoke.transport.openMixSettings':
    'Abrir los ajustes de mezcla de {channel}',
  ...
  'karaoke.pitch.show': 'Mostrar la guía de afinación',
  'karaoke.pitch.hide': 'Ocultar la guía de afinación',
  ...
  'karaoke.maker.exitBusy':
    'Todavía se está ejecutando un modelo local. Cancélalo o espera a que termine antes de salir del editor.',
  ...
  'karaoke.maker.stemMp3Encoding': 'Codificando el MP3…',
  'karaoke.maker.stemMp3Saved': 'MP3 guardado.',
  'karaoke.maker.stemMp3Failed': 'No se pudo codificar el MP3.',
  ...
  'karaoke.maker.speechMemory': 'Memoria de modelos de IA',
  ...
  'karaoke.maker.pitchDownloadFailed': 'Falló la descarga del modelo de tono',
  'karaoke.maker.pitchDownloadError':
    'FluidEQ no pudo descargar el modelo de melodía de mayor precisión. La detección continuó con el modelo sin conexión incluido. Comprueba tu conexión a Internet o el firewall e inténtalo de nuevo.',
  ...
  'karaoke.translation.exportLanguage':
    'Los archivos de letra se escribirán en {language}.',
};
