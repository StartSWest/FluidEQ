...
const karaoke: Partial<Dictionary> = {
  ...
  'karaoke.maker.stemSaveAs': '{name} の保存形式',
  'karaoke.maker.stemSaveFormat': '{name} を {format} で保存',
  'karaoke.maker.stemMp3Encoding': 'MP3 を書き出し中…',
  'karaoke.maker.stemMp3Saved': 'MP3 を保存しました。',
  'karaoke.maker.stemMp3Failed': 'MP3 の書き出しに失敗しました。',
