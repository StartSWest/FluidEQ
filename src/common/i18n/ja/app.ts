...
const app: Partial<Dictionary> = {
  ...
  'app.status.checking': 'オーディオエンジンを確認しています…',
  'app.status.error': 'オーディオエンジンが応答しません',
  'app.menu.importEq': 'EQ 設定を読み込む…',
  'app.menu.importConvolution': 'インパルス応答を読み込む…',
  'app.menu.restartAudio': 'Windows オーディオを再起動',
  'engine.apo.reconfigure': 'Equalizer APO を再設定',
  'engine.apo.settings': 'Equalizer APO の設定',
  ...
  'app.processes.what.desktop':
    'モニターのデスクトップの背景として描かれる Plus のビジュアライザーで、このウィンドウとは別に動きます。表示しているモニターごとに 1 つです。ウィンドウがそのモニターを覆っている間や PC がロックされている間は一時停止します。',
  ...
  'engine.subtitle':
    'エンジンは PC 全体で 1 つだけ動きます。切り替えると Windows が一度だけ許可を求めます。',
  'engine.now': '現在: {engine}',
  'engine.recommended': '推奨',
  'engine.fluid.name': 'FluidEQ エンジン',
  'engine.fluid.l1': 'サウンドカード本来のエフェクトとパネルはそのまま使えます',
  ...
  'engine.apo.l2':
    'サウンドカードのエフェクト枠を占有し、メーカー製パネルの項目が消えることがあります',
  'engine.apo.l3':
  ...
  'prereq.install.apo': 'APO をインストール',
  'prereq.install.fluid': 'FluidEQ エンジンをインストール',
  'prereq.retry': '再試行',
  'prereq.dismiss': '閉じる',
  'prereq.credit.apo':
    'Equalizer APO は {product} に同梱されています — 何もダウンロードされません。セットアップではどのオーディオ機器を補正するかを尋ね、最後に再起動を求めます。{author} による独立した GPLv2 プロジェクトを、そのまま同梱しています。',
  'prereq.starting': '起動中…',
  'prereq.bundleMissing':
    'このビルドには Equalizer APO が同梱されていません。代わりに公式プロジェクトを開きます。',
  'prereq.notStarted':
    'Equalizer APO が起動しませんでした — 管理者の許可が必要です。もう一度試して Windows の確認を承認してください。',
  ...
  'restart.close': '閉じる',
  'restart.declined':
    'Windows の許可が拒否されたため、オーディオは再起動されませんでした。',
  ...
  'sidebar.state.on': '{engine} · オン',
  'sidebar.state.off': 'オフ',
  'sidebar.state.notOnOutput': 'この出力では動作していません',
  'sidebar.preamp': 'プリアンプ',
  'sidebar.autoLabel': '自動',
