...
const app: Partial<Dictionary> = {
  ...
  'sidebar.autoNormalize.off': 'オフ',
  'sidebar.autoNormalize.on': 'オン',
  'sidebar.autoNormalize.smart': 'スマート',
  'sidebar.autoNormalize.aria': '自動ノーマライズのモード',
  'sidebar.preampSmart': '再生中の音から測定し、聴きながら調整します。',
