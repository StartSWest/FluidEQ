...
const tour: Partial<Dictionary> = {
  ...
  'tour.presets.point3':
    '「なし」を選べば一度ですべてのステージがオフになり、星を付けたチェーンはそのすぐ後に並びます。',
  'tour.presets.how':
    '「EQ」を開いて「プリセット」を押すか、「DSP」の上部でチェーンを選びます。',
  'tour.presets.open': 'EQ を開く',
  'tour.presets.imageAlt':
    'ロックを選んだプリセットの選択欄、そのチェーンがオンにするステージ、同じラウドネスで測定された 3 つのチェーン。',
  'tour.presets.chain': 'カーブだけでなく、チェーン全体',
  'tour.presets.level': 'すべて同じラウドネス',
  'tour.presets.levelNote': '切り替えて変わるのは音量ではなく、音の性格です。',
  'tour.tone.kicker': 'トーンコントロール',
  'tour.tone.title': '低音・中音・高音を、アンプのように',
  'tour.tone.subtitle': 'バンド全体にかかる 3 つのノブ',
  'tour.tone.lead':
    'バンドを選択していないとき、3 つのノブがそれぞれの受け持つ音域を、バンド全体にわたって一度に動かします。バンドに一つも触れずに、曲を温かくしたり明るくしたりする、いちばん手早い方法です。',
  'tour.tone.point1':
