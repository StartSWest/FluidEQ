...
const tour: Partial<Dictionary> = {
  ...
  'tour.room.point2':
    '出発点となる 24 のルーム（スタジオ、リビング、シネマ、コンサートホール…）と、名前を付けて保存した自分のルーム。',
  'tour.room.point3':
  ...
  'tour.theme.how':
    '右上のパルスアイコンのメニューを開き、いちばん下の「テーマ」で「ダーク」を選びます。「ライト」にもワンクリックで戻せます。',
  ...
  'tour.karaoke.point2':
    '「ノート」または「カーブ」表示のピッチレーン: 曲の音符はブロック、あなたの声はライブの線。高い、音程一致、低いを表示します。',
  'tour.karaoke.point3':
  ...
  'tour.media.point4':
    '進行状況ピル付きのダウンロードと、完了後の「フォルダーに表示」。「すべてのサイトからログアウト」ボタンは Cookie とログインを一度に消します。',
  'tour.media.how':
