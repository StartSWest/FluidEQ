...
const tour: Partial<Dictionary> = {
  ...
  'tour.visualizers.point1':
    'すべてを一つの選択欄から。形と色を変えられる 38 の無料スタイルと、カテゴリ別の Plus ビジュアライザー。',
  ...
  'tour.looks.subtitle': '38 の形、あなたの色、あなたの動き',
  'tour.looks.lead':
    'EQ の下のスペクトラムは好きなように描けます。シンプルなバーや線から、段丘、スカイライン、車が行き交う夜の橋まで 38 の形から一つ選び、その形に合った「自動」配色や、周波数別、レベル別、ヒート別に色を付け、アタックの速さとピークの残る長さを決め、ピークをスパーク、コメット、リップルで飾ります。自分の表示として保存し、ファイルとして共有できます。',
  'tour.looks.point1':
    '38 の形、それぞれに専用の設定: 分割数、間隔、塗り、太さ、塗りつぶしか輪郭か。',
  'tour.looks.point2':
