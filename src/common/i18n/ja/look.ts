...
const look: Partial<Dictionary> = {
  'look.textureStyle': 'テクスチャ',
  'look.texture.none': 'なし',
  'look.texture.hatch': 'ハッチング',
  'look.texture.crosshatch': 'クロスハッチ',
  'look.texture.rules': '横罫',
  'look.texture.pinstripe': 'ピンストライプ',
  'look.texture.dots': 'ドット',
  'look.texture.grid': 'グリッド',
  'look.texture.weave': '織り',
  'look.texture.scales': 'うろこ',
  'look.texture.chevron': 'シェブロン',
  'look.texture.static': 'グレイン',
  'look.texture.image': '画像',
  'look.texture.replace': '画像を変更',
  'look.texture.tooBig':
    'この画像は大きすぎて保存できません。小さいものをお試しください。',
  'look.texture.unreadable': 'このファイルは画像として読み込めませんでした。',
  'look.tilt': '傾き',
  'look.tiltHint':
    'オクターブあたりのデシベル。表示を高域側へ持ち上げ、バランスの取れたミックスが水平に見えるようにします。',
  'look.tiltValue': '{value} dB/oct',
  'look.channels': 'チャンネル',
  'look.channels.joined': 'まとめて',
  'look.channels.split': '左と右',
  'look.edit': '表示を編集',
  'look.create': '表示を作成',
  'look.new': '新しい表示',
