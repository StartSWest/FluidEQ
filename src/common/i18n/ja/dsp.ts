...
const dsp = {
  'dsp.eqPreset.modernCountry': 'モダンカントリー',
  'dsp.eqPreset.folk': 'フォーク',
  'dsp.eqPreset.bluegrass': 'ブルーグラス',
  'dsp.eqPreset.americana': 'アメリカーナ',
  'dsp.eqPreset.singerSongwriter': 'シンガーソングライター',
  'dsp.eqPreset.classicRock': 'クラシックロック',
  'dsp.eqPreset.alternativeRock': 'オルタナティブロック',
  'dsp.eqPreset.indieRock': 'インディーロック',
  ...
  'dsp.eqPreset.soul': 'ソウル',
  'dsp.eqPreset.neoSoul': 'ネオソウル',
  'dsp.eqPreset.funk': 'ファンク',
  'dsp.eqPreset.disco': 'ディスコ',
  'dsp.eqPreset.gospel': 'ゴスペル',
  'dsp.eqPreset.latin': 'ラテン',
  'dsp.eqPreset.reggaeton': 'レゲトン',
  'dsp.eqPreset.salsa': 'サルサ',
  'dsp.eqPreset.bachata': 'バチャータ',
  'dsp.eqPreset.merengue': 'メレンゲ',
  'dsp.eqPreset.cumbia': 'クンビア',
  'dsp.eqPreset.bossaNova': 'ボサノバ',
  'dsp.eqPreset.samba': 'サンバ',
  'dsp.eqPreset.flamenco': 'フラメンコ',
  'dsp.eqPreset.latinPop': 'ラテンポップ',
  'dsp.eqPreset.regionalMexican': 'メキシコ地域音楽',
  'dsp.eqPreset.corridos': 'コリード',
  'dsp.eqPreset.afrobeats': 'アフロビーツ',
  'dsp.eqPreset.afrobeat': 'アフロビート',
  'dsp.eqPreset.amapiano': 'アマピアノ',
  'dsp.eqPreset.highlife': 'ハイライフ',
  'dsp.eqPreset.dancehall': 'ダンスホール',
  'dsp.eqPreset.ska': 'スカ',
  'dsp.eqPreset.dub': 'ダブ',
  'dsp.eqPreset.house': 'ハウス',
  'dsp.eqPreset.techno': 'テクノ',
  'dsp.eqPreset.trance': 'トランス',
  'dsp.eqPreset.dubstep': 'ダブステップ',
  'dsp.eqPreset.rap': 'ラップ',
  'dsp.eqPreset.edm': 'EDM',
  'dsp.eqPreset.downtempo': 'ダウンテンポ',
  'dsp.eqPreset.chillout': 'チルアウト',
  'dsp.eqPreset.bollywood': 'ボリウッド',
  'dsp.eqPreset.bhangra': 'バングラ',
  'dsp.eqPreset.indianClassical': 'インド古典音楽',
  'dsp.eqPreset.arabicPop': 'アラビックポップ',
  'dsp.eqPreset.turkishPop': 'トルコポップ',
  'dsp.eqPreset.world': 'ワールド',
  'dsp.eqPreset.opera': 'オペラ',
  'dsp.eqPreset.newAge': 'ニューエイジ',
  'dsp.eqPreset.christian': '現代キリスト教音楽',
  'dsp.eqPreset.newWave': 'ニューウェーブ',
  'dsp.eqPreset.fusion': 'フュージョン',
  'dsp.eqPreset.smoothJazz': 'スムーズジャズ',
  ...
  'dsp.normalizer.liveGuidance':
    'ライブ音量調整は Windows が伝える曲に合わせて動作します。大きな部分でゲインを下げると曲の終わりまでその音量を保ち、次の曲もかなり静かでない限り同じ音量で再生します。一度聴いた曲は最初の1秒から調整します。増幅は最大6\u00a0dBでピーク余裕の範囲内、目標値は保証されません。再学習するにはオフにして再び有効にします。既存の歪みは修復できません。',
  ...
  'dsp.latency.hint':
    'エンジンの処理で追加される遅延です。Windows、デバイス、ネットワークの遅延は含みません。',
  'dsp.latency.title': '有効なエフェクトと処理バッファ',
  'dsp.latency.total': '合計',
  'dsp.latency.note':
  ...
  'dsp.denoise.graphClicksIn': '{{seconds}}秒で{{count}}件修復',
  'dsp.denoise.graphClicksOff': 'クリック修復オフ',
  'dsp.denoise.graphHumAt': 'ハム {{hz}} Hz',
  ...
  'dsp.surround.roomHint':
    'ルームは各チャンネルを頭のまわりに配置するため、オンの間はすべてのチャンネルを使います。オフにすると設定が戻ります。',
  ...
  'dsp.room.preset.cinema': 'シネマ',
  'dsp.room.preset.frontStage': 'フロントステージ',
  'dsp.room.preset.nearField': 'ニアフィールド',
  'dsp.room.preset.homeTheatre': 'ホームシアター',
  'dsp.room.preset.gaming': 'ゲーム',
  'dsp.room.preset.concertHall': 'コンサートホール',
  'dsp.room.preset.jazzClub': 'ジャズクラブ',
  'dsp.room.preset.club': 'クラブ',
  ...
  'dsp.room.live.fiveOne': '5.1 → 5 本のスピーカーとサブ',
  'dsp.room.live.sevenOne': '7.1 → ルーム全体',
  ...
  'dsp.room.resetHint':
    '出荷時の「リファレンス」ルームに戻し、リスナーの設定も含めてこのページのすべてをリセットします。電源スイッチだけはそのままです。',
  ...
  'dsp.scope.rawSender':
    '未処理の音声を送信しています。エフェクトは受信側のPCで適用されます。',
  'tabs.dsp': 'DSP',
};
