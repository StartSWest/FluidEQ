...
const termsNotice = {
  ...
  'termsNotice.change.5':
    'Plus can now be paid yearly as well as monthly, and a membership renews at the end of whichever period you paid for. A scene you publish in Visualizers is now seen by anyone signed in; only Plus members play and add it. Plus runs on up to 5 computers at a time, and the leaderboard adds up your computers’ listening without letting a day grow faster than the clock.',
} as const;
