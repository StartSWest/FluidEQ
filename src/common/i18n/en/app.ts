...
const app = {
  ...
  'app.status.checking': 'Checking the audio engine…',
  'app.status.error': 'The audio engine is not responding',
  ...
  'engine.apo.reconfigure': 'Reconfigure Equalizer APO',
  'engine.apo.settings': 'Equalizer APO settings',
  ...
  'engine.subtitle':
    'One engine runs for the whole PC. Switching asks Windows for permission once.',
  'engine.now': 'Now: {engine}',
  ...
  'engine.apo.l2':
    'Takes over your sound card’s effect slot; vendor panels can lose controls',
  'engine.apo.l3':
  ...
  'prereq.install.apo': 'Install APO',
  'prereq.install.fluid': 'Install FluidEQ Engine',
  'prereq.retry': 'Retry',
  'prereq.dismiss': 'Dismiss',
  'prereq.credit.apo':
    'Equalizer APO is included with {product} — nothing will be downloaded. Its setup will ask which audio devices to equalise, and for a restart afterwards. Separate GPLv2 project by {author}, bundled unchanged.',
  'prereq.starting': 'Starting…',
  ...
  'sidebar.state.on': '{engine} · on',
  'sidebar.state.off': 'Off',
  'sidebar.state.notOnOutput': 'Not on this output',
