...
const tour = {
  ...
  'tour.visualizers.point1':
    'One picker for everything: {styles} free styles to shape and colour, and Plus visualizers by category.',
  ...
  'tour.looks.subtitle': 'Your forms, your colours, your motion',
  'tour.looks.lead':
    'The spectrum under the EQ can be drawn any way you like. Pick one of {forms} forms, from LED and neon bars to terraces, skylines and glass towers, then colour it in its own Auto colouring, by frequency, by level or by heat, set how fast it attacks and how long a peak hangs, and mark the peaks with sparks, comets or ripples. Save it as a look of your own, and share it as a file.',
  'tour.looks.point1':
    '{forms} forms, each with its own controls: pieces, gap, fill, weight, and whether it is filled or stroked.',
  'tour.looks.point2':
