...
const look = {
  ...
  'look.texture.none': 'Plain',
  'look.texture.hatch': 'Hatch',
  'look.texture.crosshatch': 'Cross-hatch',
  'look.texture.rules': 'Rules',
  'look.texture.pinstripe': 'Pinstripe',
  'look.texture.dots': 'Dots',
  'look.texture.grid': 'Grid',
  'look.texture.weave': 'Weave',
  'look.texture.scales': 'Scales',
  'look.texture.chevron': 'Chevron',
  'look.texture.static': 'Grain',
  'look.texture.image': 'Picture',
  'look.texture.replace': 'Change picture',
  'look.texture.tooBig':
    'That picture is too large to keep. Try a smaller one.',
  'look.texture.unreadable': 'That file could not be read as a picture.',
  'look.tilt': 'Slope',
  'look.tiltHint':
    'Decibels per octave. Tips the display up toward the treble, so a balanced mix reads level.',
  'look.tiltValue': '{value} dB/oct',
  'look.channels': 'Channels',
  'look.channels.joined': 'Joined',
  'look.channels.split': 'Left & right',
  'look.edit': 'Edit look',
