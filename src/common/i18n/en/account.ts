...
const account = {
  ...
  'account.plus.pitch':
    'Premium visualizers that exist nowhere else, the Studio for making your own, the leaderboard — and every new feature from here on, for members first. Everything that is free today stays free.',
