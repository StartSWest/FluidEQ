...
const dsp = {
  ...
  'dsp.eq.isolateOn':
    'The dry signal is removed — you hear only what the EQ changes: what a boost adds and what a cut takes away.',
  ...
  'dsp.eq.legend.isolated': 'Added / removed',
