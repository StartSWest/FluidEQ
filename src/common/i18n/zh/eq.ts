...
const eq: Partial<Dictionary> = {
  ...
  'graph.sceneTint.label': '窗口颜色',
  'graph.sceneTint.about.off': '窗口保持你的主题。',
  'graph.sceneTint.about.tint': '窗口换上可视化效果的颜色。',
  ...
  'output.hint':
    '修改会保存到当前启用的配置，并在 Windows 选中该输出时跟着走。',
  ...
  'eq.smart.error.noSource': '无法获取 FluidEQ 处理前的声音。',
  ...
  'convolution.intro':
    '下载经过验证的最小相位耳机脉冲响应，在参数均衡之前应用。频响图会同时显示两条曲线。',
