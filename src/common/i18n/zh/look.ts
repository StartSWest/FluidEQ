...
const look: Partial<Dictionary> = {
  'look.textureStyle': '纹理',
  'look.texture.none': '无',
  'look.texture.hatch': '斜纹',
  'look.texture.crosshatch': '交叉斜纹',
  'look.texture.rules': '横线',
  'look.texture.pinstripe': '细竖纹',
  'look.texture.dots': '圆点',
  'look.texture.grid': '网格',
  'look.texture.weave': '编织',
  'look.texture.scales': '鱼鳞',
  'look.texture.chevron': '人字纹',
  'look.texture.static': '颗粒',
  'look.texture.image': '图片',
  'look.texture.replace': '更换图片',
  'look.texture.tooBig': '这张图片太大，无法保存。请换一张小一些的。',
  'look.texture.unreadable': '无法将该文件读取为图片。',
  'look.tilt': '斜率',
  'look.tiltHint':
    '每倍频程的分贝数。把显示向高频抬起，平衡的混音看起来就是平的。',
  'look.tiltValue': '{value} dB/倍频程',
  'look.channels': '声道',
  'look.channels.joined': '合并',
  'look.channels.split': '左右分开',
  'look.edit': '编辑外观',
  'look.create': '创建外观',
  'look.new': '新建外观',
  'look.close': '关闭外观编辑器',
