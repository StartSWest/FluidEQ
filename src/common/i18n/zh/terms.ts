const terms = {
  ...
  'terms.sent.scenePublish.who':
    '在你取消发布之前，于“可视化”中：所有已登录 FluidEQ 的人都能看到它的图片、名称、分类和你的显示名，Plus 会员还可以播放和添加它。作者会保留你发布过的记录，与导出相同。',
  ...
  'terms.scenes.p9':
    '如果你把场景发布到“可视化”，你也允许 FluidEQ 在你取消发布之前把它保存在那里，把它的图片、名称、分类和你的显示名展示给所有已登录 FluidEQ 的人，并把场景本身提供给 Plus 会员播放和添加。无论是否拥有 Plus，你都可以随时取消发布。已添加它的会员会保留自己的副本，条件与你发给他们的文件相同。',
  'terms.scenes.p10':
