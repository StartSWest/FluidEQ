const terms = {
  ...
  'terms.account.p4':
    'Plus 最多可同时在 5 台电脑上使用——家里和公司，或“共享音频”在其间播放的那些电脑。在第六台电脑上登录，会让最久未使用的那台退出登录。',
  ...
  'terms.sent.scenePublish.who':
    '在你取消发布之前，于“可视化”中：所有已登录 FluidEQ 的人都能看到它的图片、名称、分类和你的显示名，并能观看它播放几秒钟；Plus 会员可以完整播放和添加它。作者会保留你发布过的记录，与导出相同。',
  ...
  'terms.sent.forum.what':
    '在“论坛”标签页中：你发布、编辑、做出反应或删除的内容，附带你的 GitHub 登录信息',
  'terms.sent.forum.when':
    '打开论坛会下载其公开话题，其中不含任何关于你的信息；其余内容只在你使用 GitHub 登录并发帖之后才会发送',
  ...
  'terms.fair.p2':
    '每个人获得积分的方式都一样，作者也不例外。篡改应用或其发送的数据、自动化收听、或用多个账户刷榜，都会被移出排行榜，还可能导致该账户无法发布场景和点赞。',
  'terms.fair.p3':
    '你的场景每获得一个赞，就得 {likePoints} 分。每位会员对每个场景只计一次，只计 Plus 会员的赞，且永远不计你自己账户的赞。用你自己的第二个账户点赞，视同用多个账户刷榜。',

  'terms.rules.title': '发布内容的规则',
  'terms.rules.p1':
    '友善待人。无论是场景本身、它的名称还是它的图片，都禁止出现骚扰、仇恨、威胁、垃圾信息、违法内容，以及任何人的个人信息。所有已登录的人都能看到你发布的内容，只分享你愿意被人看到的内容。',
  'terms.rules.p2':
    '你可以随时取消发布自己的场景。作者可以下架违反这些规则的场景并暂停相关账户。举报一个场景即可标记它；只有作者能看到举报。',
  ...
  'terms.keep.p4':
    '你的账户：申请删除后，它会在 {deletionDays} 天内连同你的个人资料、排行榜记录和会员记录一起删除。',
  'terms.keep.p5':
  ...
  'terms.scenes.p6':
    '只分享你有权分享的作品：你自己的照片和绘画，或其所有者允许使用的作品。发布内容的规则适用于你分享的每一个场景。如果某个场景违反本条款或侵犯他人权利，作者可以阻止它被打开。',
  'terms.scenes.p7':
    '其他会员分享的场景是他们的作品，在你是会员期间授权你个人使用。你可以播放它、为它点赞，并把文件原样转给其他 Plus 会员。请不要修改它、把它当作你的作品、在其他地方发布或出售它。',
  'terms.scenes.p8':
    '下架场景会停止图库中的新下载。已下载的副本不会被删除，其许可也不会被撤销；用户仍可在拥有 Plus 时将其用于个人用途。FluidEQ 可以封禁违反这些条款或侵犯他人权利的场景。',
  'terms.scenes.p9':
    '如果你把场景发布到“可视化”，你也允许 FluidEQ 在你取消发布之前把它保存在那里，把它的图片、名称、分类和你的显示名展示给所有已登录 FluidEQ 的人，为他们播放几秒钟，并把场景本身提供给 Plus 会员完整播放和添加。无论是否拥有 Plus，你都可以随时取消发布。已添加它的会员会保留自己的副本，条件与你发给他们的文件相同。',
  'terms.scenes.p10':
