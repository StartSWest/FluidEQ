...
const tour: Partial<Dictionary> = {
  ...
  'tour.room.point2':
    '二十四个起点房间——录音室、客厅、影院、音乐厅——再加上你自己命名保存的房间。',
  'tour.room.point3':
  ...
  'tour.theme.point2':
    '所有窗口同步：菜单、对话框、卡拉OK 舞台和媒体库一起切换。',
  'tour.theme.point3':
    '你的强调色和彩虹模式保持不变。声音没有任何变化，只是换了外衣。',
  'tour.theme.howTitle': '如何切换',
  'tour.theme.how':
    '打开右上角脉冲图标后的菜单，在底部的“主题”中选择“深色”。想换回来时，“浅色”只需一次点击。',
  ...
  'tour.library.point4':
    '智能均衡歌曲记忆：播放时打开“为这首歌保存”，你做的修正就会为这首歌记住。',
  'tour.library.how':
  ...
  'tour.karaoke.point1':
    '“引导人声”滑块从原曲一直滑到仅伴奏，不需要额外文件就能去掉主唱。',
  'tour.karaoke.point2':
    '音高轨道有“音符”和“曲线”两种视图：歌曲的音符是方块，你的声音是实时的线，并提示偏高、音准正确或偏低。',
  'tour.karaoke.point3':
  ...
  'tour.media.point2': '“拦截广告”会跳过视频广告并隐藏 YouTube 上的广告位。',
  'tour.media.point3':
    '续播：播放器记住最后一页以及你看到的位置，并带你回到那里。',
  'tour.media.point4':
    '下载带进度提示，完成后可“在文件夹中显示”；还有一个“退出所有网站登录”按钮，一键清除全部 Cookie 和登录。',
  'tour.media.how':
