...
const tour: Partial<Dictionary> = {
  ...
  'tour.plus.lead':
    '这是一项可选的会员服务，支持 FluidEQ 持续成长，并拥有一个全新的专属标签页：由显卡绘制的场景、用来创作自己场景的工作室、排行榜、桌面背景和动态灯效。原本免费的一切依然免费。',
  'tour.plus.point1':
  ...
  'tour.visualizers.point1':
    '一个选择器包揽一切：38 种可自行塑形和配色的免费样式，以及按分类排列的 Plus 可视化效果。',
  ...
  'tour.looks.subtitle': '三十八种形态，你的颜色，你的律动',
  'tour.looks.lead':
    'EQ 下方的频谱可以按你喜欢的任何方式绘制。从三十八种形态中挑一种，从简单的柱状和线条到梯田、天际线和车流穿行的夜间大桥；用它自己的“自动”配色，或按频率、按电平、按热度上色；设定起音多快、峰值停留多久；再用火花、彗星或涟漪标记峰值。保存为你自己的外观，并以文件形式分享。',
  'tour.looks.point1':
    '三十八种形态，各有自己的控制项：段数、间距、填充、粗细，以及填充还是描边。',
  'tour.looks.point2':
