...
const app: Partial<Dictionary> = {
  ...
  'sidebar.autoNormalize.off': '关闭',
  'sidebar.autoNormalize.on': '开启',
  'sidebar.autoNormalize.smart': '智能',
  'sidebar.autoNormalize.aria': '自动归一化模式',
  'sidebar.preampSmart': '根据正在播放的内容测量，并在聆听时持续调整。',
