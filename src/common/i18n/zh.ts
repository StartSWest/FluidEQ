...
const zh: Partial<Dictionary> = {
  ...
  'eq.smart.mode.once.note': '测量一次即停止',
  'eq.smart.mode.detail': '细节',
  'eq.smart.mode.detail.note': '修正峰谷，保留唱片本身的个性',
  'eq.smart.mode.balance': '平衡',
  'eq.smart.mode.balance.note': '同时统一各唱片的明亮或温暖程度',
  'eq.smart.mode.target': '目标',
  'eq.smart.mode.target.note': '把每张唱片带到相同的音色平衡',
  'eq.layers': '同时生效',
