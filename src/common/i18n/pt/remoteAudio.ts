...
const remoteAudio: Partial<Dictionary> = {
  ...
  'remoteAudio.monitor.receiving': 'Recebendo',
  'remoteAudio.monitor.quiet': 'Silencioso',
  'remoteAudio.monitor.nowPlaying': 'Tocando agora',
  'remoteAudio.monitor.paused': 'Em pausa',
