const termsNotice = {
  ...
  'termsNotice.version': 'Versão {version}',
  ...
  'termsNotice.change.3':
    'As cenas que crias no Estúdio continuam a ser tuas: partilhar uma por ficheiro permite que outros membros a reproduzam, e as curtidas nela dão-te pontos na classificação.',
