const engineUpdate = {
  ...
  'engineUpdate.declined':
    'A permissão do Windows foi negada, então o seu EQ continua tocando pelo motor que você tinha.',
  'engineUpdate.failed':
    'Não foi possível atualizar o motor, então o seu EQ continua tocando pelo que você tinha.',
} as const;
