...
const look: Partial<Dictionary> = {
  ...
  'look.peakLayer': 'Posição dos picos',
  'look.peakFront': 'À frente da onda',
  'look.peakBehind': 'Atrás da onda',
  ...
  'look.peakStyle': 'Marca',
  'look.peak.fall': 'Queda',
  'look.peak.ghost': 'Fantasma',
  'look.peak.ripple': 'Ondulação',
  'look.peak.sparks': 'Faíscas',
  'look.peak.beam': 'Feixe',
  'look.peak.ceiling': 'Teto',
  'look.peak.comet': 'Cometa',
  'look.peak.drip': 'Gota',
  'look.peak.bead': 'Caixa',
  'look.peak.cap': 'Tampa',
  'look.peak.ring': 'Anel',
  'look.peak.spark': 'Faísca',
  'look.peak.chevron': 'Divisa',
  'look.peak.halo': 'Halo',
  'look.peak.pin': 'Alfinete',
  'look.peak.crown': 'Coroa',
  'look.peak.cross': 'Cruz',
  'look.peak.wave': 'Onda',
