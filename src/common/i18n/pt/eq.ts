...
const eq: Partial<Dictionary> = {
  ...
  'squigImport.intro':
    'Usa a calculadora do Squiglink e cola aqui a exportação. Aplicar como EQ substitui as bandas editáveis. Aplicar como curva substitui a correção dos auscultadores, como no OPRA, com intensidade e interruptor próprios; as bandas de EQ ficam iguais.',
  ...
  'squigImport.stepThree': 'Cola abaixo e escolhe EQ ou curva',
  ...
  'squigImport.replaceBody':
    'Substituir o EQ elimina as bandas atuais. Podes aplicar esta importação como uma curva de correção separada. Mudar de modo remove a importação anterior.',
