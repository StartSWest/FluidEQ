...
const look: Partial<Dictionary> = {
  'look.connectingLine': 'Ligne de liaison',
  'look.peak.blink': 'Clignotement au rythme',
  ...
  'look.peakStyle': 'Marque',
  'look.peak.fall': 'Retombée',
  'look.peak.ghost': 'Fantôme',
  'look.peak.ripple': 'Onde',
  'look.peak.sparks': 'Étincelles',
  'look.peak.beam': 'Faisceau',
  'look.peak.ceiling': 'Plafond',
  'look.peak.comet': 'Comète',
  'look.peak.drip': 'Goutte',
  'look.peak.bead': 'Boîte',
  'look.peak.cap': 'Capuchon',
  'look.peak.ring': 'Anneau',
  'look.peak.spark': 'Étincelle',
  'look.peak.chevron': 'Chevron',
  'look.peak.halo': 'Halo',
  'look.peak.pin': 'Épingle',
  'look.peak.crown': 'Couronne',
  'look.peak.cross': 'Croix',
  'look.peak.wave': 'Onde',
