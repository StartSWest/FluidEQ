...
const app: Partial<Dictionary> = {
  ...
  'app.processes.total': '{megabytes} Mo et {cpu} % de processeur au total.',
  ...
  'app.processes.name.shareCapture': 'Capture audio',
  ...
  'app.processes.name.games': 'Détection des jeux',
  'app.processes.what.games':
    'Indique à FluidEQ quel programme est au premier plan, pour qu’un jeu ait son propre son dès que vous y passez. Ne tourne que lorsqu’un jeu a un son à lui ou que la page Préréglages de jeu est ouverte.',
  'app.processes.name.outputs': 'Veille des sorties',
  'app.processes.what.outputs':
    'Entend Windows signaler qu’une sortie a été branchée, débranchée ou modifiée, pour que FluidEQ passe au profil de cette sortie même quand sa fenêtre est masquée. Tourne tant que FluidEQ tourne.',
  'app.processes.name.mediaWatch': 'Médias des autres apps',
  'app.processes.what.mediaWatch':
    "Lit ce que joue Spotify, un navigateur ou un autre lecteur, pour que la barre du lecteur puisse l'afficher et le piloter. S'arrête quand FluidEQ n'en a plus besoin.",
  ...
  'app.processes.name.meter': 'Mesure des processus',
  'app.processes.what.meter':
    'Mesure les chiffres de cette liste comme le Gestionnaire des tâches, pour que leur somme soit juste. Ne tourne que tant que cette liste est ouverte.',
  'app.processes.name.lighting': 'Éclairage dynamique',
  'app.processes.what.lighting':
    'Transmet les couleurs de la scène aux appareils compatibles avec Windows Dynamic Lighting. Ne tourne que lorsque l’éclairage est activé ou que sa page est ouverte.',
  ...
  'engine.fluid.l4':
    'Equalizer APO est désactivé pendant que ce moteur tourne, et remis exactement comme il était si vous y revenez',
  ...
  'app.tray.recoverWindow': 'Récupérer la fenêtre',
  ...
  'sidebar.state.on': '{engine} · actif',
  'sidebar.state.off': 'Désactivé',
  'sidebar.state.notOnOutput': 'Absent de cette sortie',
  ...
  'settings.group.visualizer': 'Le visualiseur',
