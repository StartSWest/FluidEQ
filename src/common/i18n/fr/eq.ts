...
const eq: Partial<Dictionary> = {
  ...
  'graph.scene.resetView': 'Réinitialiser la vue',
  ...
  'graph.sceneTint.label': 'Couleurs de la fenêtre',
  'graph.sceneTint.about.off': 'La fenêtre dans votre thème.',
  'graph.sceneTint.about.tint': 'La fenêtre aux couleurs du visualiseur.',
  'graph.sceneTint.about.pulse':
    'Ses couleurs, et la fenêtre qui s’illumine avec la musique.',
  ...
  'graph.styleName.bouncedots': 'Points rebondissants',
  ...
  'graph.meter.mono': 'M',
  'output.title': 'Sortie',
  'output.playing': 'Lecture : {profile}',
  ...
  'output.hint':
    'Les modifications s’enregistrent dans le profil actif et suivent cette sortie chaque fois que Windows la sélectionne.',
  ...
  'convolution.intro':
    'Téléchargez une réponse impulsionnelle à phase minimale vérifiée pour votre casque et appliquez-la avant l’égaliseur paramétrique. La courbe de réponse affiche les deux.',
