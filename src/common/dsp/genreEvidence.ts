 ...
 *
 * Measured 2026-09-24 by rendering every chain, its curve after its rack as
...
> = {
  ...
  alternativeRock: [0.41, -0.86],
  indieRock: [0.6, -0.9],
  progressiveRock: [0.15, -0.86],
  hardRock: [0.61, -0.86],
  metal: [0.14, -0.88],
  punk: [0.41, -0.86],
  popPunk: [0.43, -0.86],
  grunge: [0.38, -0.87],
  country: [0.59, -0.87],
  modernCountry: [0.36, -0.86],
  americana: [0.23, -0.87],
  bluegrass: [0.2, -0.88],
  folk: [0.35, -0.88],
  acoustic: [0.34, -0.86],
  singerSongwriter: [0.24, -0.88],
  hiphop: [0.28, -0.86],
  rap: [0.55, -0.89],
  trap: [-0.09, -0.87],
  rnb: [0.55, -0.87],
