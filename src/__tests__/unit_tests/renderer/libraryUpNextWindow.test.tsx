...
// The queue's songs as the store has answered them: every one read.
jest.mock('renderer/library/useLibraryTracks', () => ({
  useLibraryTracks: () => new Map(mockTracks.map((track) => [track.id, track])),
}));
