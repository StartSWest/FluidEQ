 ...
 * titlebar, for everybody who had never played. With Rainbow mode on there
 * is always joy, and the class is still what the stylesheet asks.
 */
...
// Rainbow mode is on by default (Ivan, 2026-09-26), and forced euphoria
...
it('keeps them when a run ends, and leaves them out with the mode off', () => {
  render(<EuphoriaGlow />);
  act(() => {
