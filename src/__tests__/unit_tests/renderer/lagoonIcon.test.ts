 ...
 * with, the stylesheet's root tokens, the header's mark and the icon file —
...
describe('Lagoon, everywhere it is written', () => {
  ...
  it('edges the header’s mark, in order', () => {
    const mark = ruleBody(css('SignalBrand.scss'), '.brand-mark--signal');
