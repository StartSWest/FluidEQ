Feature: Set quality of a frequency band
  ...
  Scenario: Select a new quality using the input field
    ...
    Then FluidEQ config file should show a quality of 1.4 for the band with frequency 125Hz
  ...
  Scenario: Select a new quality using the arrow buttons
    ...
    Then FluidEQ config file should show a quality of 0.52 for the band with frequency 125Hz
