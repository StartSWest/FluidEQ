...
const TrashIcon = ({
  className = '',
  /**
   * Defaults to the fixed grey the icon buttons have always drawn it in.
   * Pass `currentColor` where the icon has to follow the control it sits in —
   * a button that dims when disabled and lights on hover cannot have one part
   * of it staying the same colour throughout.
   */
  fill = '#718792',
}: {
  className?: string;
