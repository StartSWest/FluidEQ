...
const GLYPHS = {
  ...
  // Shafts of light widening up from the floor.
  beams: {
    d: 'M1.8 15L1 6H4L3.2 15ZM5.5 15L4.7 2.5H7.7L6.9 15ZM9.1 15L8.3 5H11.3L10.5 15ZM12.7 15L11.9 8H14.9L14.1 15Z',
    isFilled: true,
  },
  ...
  // A wavy skin round a sphere and its core.
  orb: {
    d: 'M14.2 8L14.69 8.88L14.83 9.83L14.5 10.69L13.76 11.32L12.83 11.7L11.93 11.93L11.23 12.21L10.71 12.69L10.24 13.41L9.66 14.21L8.9 14.85L8 15.1L7.1 14.85L6.34 14.21L5.76 13.41L5.29 12.69L4.77 12.21L4.07 11.93L3.17 11.7L2.24 11.32L1.5 10.69L1.17 9.83L1.31 8.88L1.8 8L2.4 7.26L2.85 6.62L3.04 5.95L3.02 5.13L2.99 4.15L3.17 3.17L3.68 2.37L4.51 1.96L5.5 1.95L6.46 2.24L7.28 2.56L8 2.7L8.72 2.56L9.54 2.24L10.5 1.95L11.49 1.96L12.32 2.37L12.83 3.17L13.01 4.15L12.98 5.12L12.96 5.95L13.15 6.62L13.6 7.26L14.2 8ZM4.4 8a3.6 3.6 0 1 0 7.2 0a3.6 3.6 0 1 0 -7.2 0ZM6.6 8a1.4 1.4 0 1 0 2.8 0a1.4 1.4 0 1 0 -2.8 0Z',
    isFilled: false,
  },
  // An eight-petal flower.
  kaleido: {
    d: 'M10.4 8L11.58 8.23L12.66 8.61L13.54 9.1L14.17 9.65L14.48 10.2L14.47 10.68L14.14 11.03L13.53 11.19L12.7 11.14L11.73 10.86L10.7 10.37L9.7 9.7L10.37 10.7L10.86 11.73L11.14 12.7L11.19 13.53L11.03 14.14L10.68 14.47L10.2 14.48L9.65 14.17L9.1 13.54L8.61 12.66L8.23 11.58L8 10.4L7.77 11.58L7.39 12.66L6.9 13.54L6.35 14.17L5.8 14.48L5.32 14.47L4.97 14.14L4.81 13.53L4.86 12.7L5.14 11.73L5.63 10.7L6.3 9.7L5.3 10.37L4.27 10.86L3.3 11.14L2.47 11.19L1.86 11.03L1.53 10.68L1.52 10.2L1.83 9.65L2.46 9.1L3.34 8.61L4.42 8.23L5.6 8L4.42 7.77L3.34 7.39L2.46 6.9L1.83 6.35L1.52 5.8L1.53 5.32L1.86 4.97L2.47 4.81L3.3 4.86L4.27 5.14L5.3 5.63L6.3 6.3L5.63 5.3L5.14 4.27L4.86 3.3L4.81 2.47L4.97 1.86L5.32 1.53L5.8 1.52L6.35 1.83L6.9 2.46L7.39 3.34L7.77 4.42L8 5.6L8.23 4.42L8.61 3.34L9.1 2.46L9.65 1.83L10.2 1.52L10.68 1.53L11.03 1.86L11.19 2.47L11.14 3.3L10.86 4.27L10.37 5.3L9.7 6.3L10.7 5.63L11.73 5.14L12.7 4.86L13.53 4.81L14.14 4.97L14.47 5.32L14.48 5.8L14.17 6.35L13.54 6.9L12.66 7.39L11.58 7.77L10.4 8ZM6.6 8a1.4 1.4 0 1 0 2.8 0a1.4 1.4 0 1 0 -2.8 0Z',
    isFilled: false,
  },
  // Two strands crossing, rungs between.
  helix: {
    d: 'M1 8L1.47 9.55L1.93 10.94L2.4 12.05L2.87 12.76L3.33 13L3.8 12.76L4.27 12.05L4.73 10.94L5.2 9.55L5.67 8L6.13 6.45L6.6 5.06L7.07 3.95L7.53 3.24L8 3L8.47 3.24L8.93 3.95L9.4 5.06L9.87 6.45L10.33 8L10.8 9.55L11.27 10.94L11.73 12.05L12.2 12.76L12.67 13L13.13 12.76L13.6 12.05L14.07 10.94L14.53 9.55L15 8M1 8L1.47 6.45L1.93 5.06L2.4 3.95L2.87 3.24L3.33 3L3.8 3.24L4.27 3.95L4.73 5.06L5.2 6.45L5.67 8L6.13 9.55L6.6 10.94L7.07 12.05L7.53 12.76L8 13L8.47 12.76L8.93 12.05L9.4 10.94L9.87 9.55L10.33 8L10.8 6.45L11.27 5.06L11.73 3.95L12.2 3.24L12.67 3L13.13 3.24L13.6 3.95L14.07 5.06L14.53 6.45L15 8M1.47 9.55V6.45M2.87 12.76V3.24M4.27 12.05V3.95M5.67 8V8M7.07 3.95V12.05M8.47 3.24V12.76M9.87 6.45V9.55M11.27 10.94V5.06M12.67 13V3M14.07 10.94V5.06',
    isFilled: false,
  },
  // Ridges receding, lines down the columns.
  mesh: {
    d: 'M1 14L3.8 11.5L6.6 10L9.4 12.5L12.2 11L15 13.5M2.54 9.67L4.72 8.5L6.91 10.45L9.09 9.28L11.28 11.23L13.46 11.62M4.08 7L5.65 8.4L7.22 7.56L8.78 8.96L10.35 9.24L11.92 7.84M5.62 6.35L6.57 5.84L7.52 6.69L8.48 6.86L9.43 6.01L10.38 5.5M1 14L2.54 9.67L4.08 7L5.62 6.35M3.8 11.5L4.72 8.5L5.65 8.4L6.57 5.84M6.6 10L6.91 10.45L7.22 7.56L7.52 6.69M9.4 12.5L9.09 9.28L8.78 8.96L8.48 6.86M12.2 11L11.28 11.23L10.35 9.24L9.43 6.01M15 13.5L13.46 11.62L11.92 7.84L10.38 5.5',
    isFilled: false,
  },
