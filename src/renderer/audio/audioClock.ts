...
} from '../lighting/lightingSceneMessages';

/**
 * A tick every thirtieth of a second of audio, on any context that renders.
 *
 * The clock the desk lights are drawn to (`lightingClock.worklet.ts`), put on
 * whatever context needs one. It counts the samples the audio thread renders,
...
export const AUDIO_CLOCK_TICKS_PER_SECOND = LIGHTING_TICKS_PER_SECOND;
