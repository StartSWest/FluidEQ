...
> Historical QA snapshot from 2026-09-04. Verdicts were recorded against the tree at that date and have not been re-validated since.

- Source visual truth: seven reference captures supplied by Ivan at review time (not kept in the repository).
- Implementation screenshots:
  - `design-qa-responsive-mobile.png`
  - `design-qa-responsive-media.png`
  - `design-qa-responsive-karaoke.png`
  - `design-qa-waveform-live.png`
  - `design-qa-karaoke-doubleclick-fullscreen.png`
  - `design-qa-karaoke-doubleclick-normal.png`
  - `design-qa-karaoke-graph-overlay.png`
  - `design-qa-karaoke-graph-header.png`
  - `design-qa-karaoke-graph-no-header.png`
...
- Source visual truth:
  - (machine-local capture, not kept in the repository)
  - (machine-local capture, not kept in the repository)
  - (machine-local capture, not kept in the repository)
- Implementation screenshots:
  - (machine-local capture, not kept in the repository)
