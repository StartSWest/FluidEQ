...
6. After preview acceptance, add lifecycle/IPC/native regression coverage, update scene-runner mocks for the narrow context, and run the required suites. Inspect and stage only the exact wallpaper changes, commit, and push.
